...
`))},on.LINEAR_TO_LINEAR="LinearToLinear",on.SRGB_TO_LINEAR="sRGBToLinear",on.LINEAR_TO_SRGB="LinearTosRGB";var Gt=class extends ${constructor(t="",n,e,i,a){super(t,a,i,e,n),this.nodeType="Expression"}},en=class extends Be{constructor(t=new zi,n,e,i){super("v4",{shared:!0}),this.nodeType="Texture",this.value=t,this.uv=n??new ga,this.bias=e,this.project=i!==void 0&&i}getTexture(t,n){return super.generate(t,n,this.value.uuid,"t")}generate(t,n){if(n==="sampler2D")return this.getTexture(t,n);let e,i,a=this.getTexture(t,n),r=this.uv.build(t,this.project?"v4":"v2"),o=this.bias?this.bias.build(t,"f"):void 0;o===void 0&&t.context.bias&&(o=t.context.bias.setTexture(this).build(t,"f")),e=this.project?"texture2DProj":o?"tex2DBias":"tex2D",i=o?e+"( "+a+", "+r+", "+o+" )":e+"( "+a+", "+r+" )";let l={include:t.isShader("vertex"),ignoreCache:!0},u=this.getType(t);return t.addContext(l),this.colorSpace=this.colorSpace??new on(new Gt("",u)),this.colorSpace.fromDecoding(t.getTextureEncodingFromMap(this.value)),this.colorSpace.input.parse(i),i=this.colorSpace.build(t,u),t.removeContext(),t.format(i,u,n)}},Z=class extends Be{constructor(t){super("f"),this.nodeType="Float",this.value=t??0}generateReadonly(t,n,e,i,a,r){return t.format(this.value+(this.value%1?"":".0"),i,n)}},$r=class extends Ot{constructor(t,n){super(),this.inputs=[],this.nodeType="FunctionCall",this.value=t,this.inputs=n??[]}getFunction(){return this.value}getType(t){return this.value.getType(t)}generate(t,n,e,i,a){i=this.getType(t);let r=this.value,o=r.build(t,n)+"( ",l=[];if(r.inputs){for(let u=0;u<r.inputs.length;u++){let c=r.inputs[u],s=this.inputs[u]||this.inputs[c.name];l.push(s.build(t,t.getTypeByFormat(c.type)))}o+=l.join(", ")+" )"}return t.format(o,i,n)}},ts=class extends Ot{constructor(t,n,e=ts.ADD){super(),this.nodeType="Operator",this.type=t.type,this.a=t,this.b=n,this.op=e}getType(t){let n=this.a.getType(t),e=this.b.getType(t);return t.isTypeMatrix(n)?"v4":t.getTypeLength(e)>t.getTypeLength(n)?e:n}generate(t,n){let e=this.getType(t);this.type=e;let i=this.a.build(t,e),a=this.b.build(t,e);return t.format("( "+i+" "+this.op+" "+a+" )",e,n)}},Oe=ts;Oe.ADD="+",Oe.SUB="-",Oe.MUL="*",Oe.DIV="/";var Wt=class extends Ot{constructor(t,n=Wt.ABS,e,i){super(),this.nodeType="Math",this.a=t,typeof n!="string"?this.b=n:i=n,typeof e!="string"?this.c=e:i=e,this.method=i,this.hashProperties=["method"]}getNumInputs(t){switch(this.method){case Wt.MIX:case Wt.CLAMP:case Wt.REFRACT:case Wt.SMOOTHSTEP:case Wt.FACEFORWARD:return 3;case Wt.MIN:case Wt.MAX:case Wt.MOD:case Wt.STEP:case Wt.REFLECT:case Wt.DISTANCE:case Wt.DOT:case Wt.CROSS:case Wt.POW:return 2;default:return 1}}getInputType(t){let n=t.getTypeLength(this.a.getType(t)),e=this.b?t.getTypeLength(this.b.getType(t)):0,i=this.c?t.getTypeLength(this.c.getType(t)):0;return n>e&&n>i?this.a.getType(t):e>i?this.b.getType(t):this.c.getType(t)}getType(t){switch(this.method){case Wt.LENGTH:case Wt.DISTANCE:case Wt.DOT:return"f";case Wt.CROSS:return"v3"}return this.getInputType(t)}generate(t,n){let e,i,a,r=this.a?t.getTypeLength(this.a.getType(t)):0,o=this.b?t.getTypeLength(this.b.getType(t)):0,l=this.c?t.getTypeLength(this.c.getType(t)):0,u=this.getInputType(t),c=this.getType(t);switch(this.type=c,this.method){case Wt.NEGATE:return t.format("( -"+this.a.build(t,u)+" )",u,n);case Wt.INVERT:return t.format("( 1.0 - "+this.a.build(t,u)+" )",u,n);case Wt.CROSS:e=this.a.build(t,"v3"),i=this.b.build(t,"v3");break;case Wt.STEP:e=this.a.build(t,r===1?"f":u),i=this.b.build(t,u);break;case Wt.MIN:case Wt.MAX:case Wt.MOD:e=this.a.build(t,u),i=this.b.build(t,o===1?"f":u);break;case Wt.REFRACT:e=this.a.build(t,u),i=this.b.build(t,u),a=this.c.build(t,"f");break;case Wt.MIX:e=this.a.build(t,u),i=this.b.build(t,u),a=this.c.build(t,l===1?"f":u);break;default:e=this.a.build(t,u),this.b&&(i=this.b.build(t,u)),this.c&&(a=this.c.build(t,u))}let s=[];s.push(e),i&&s.push(i),a&&s.push(a);let p=this.getNumInputs(t);if(s.length!==p)throw Error(`Arguments not match used in "${this.method}". Require ${p}, currently ${s.length}.`);return t.format(this.method+"( "+s.join(", ")+" )",c,n)}},bt=Wt;bt.RAD="radians",bt.DEG="degrees",bt.EXP="exp",bt.EXP2="exp2",bt.LOG="log",bt.LOG2="log2",bt.SQRT="sqrt",bt.INV_SQRT="inversesqrt",bt.FLOOR="floor",bt.CEIL="ceil",bt.NORMALIZE="normalize",bt.FRACT="fract",bt.SATURATE="saturate",bt.SIN="sin",bt.COS="cos",bt.TAN="tan",bt.ASIN="asin",bt.ACOS="acos",bt.ARCTAN="atan",bt.ABS="abs",bt.SIGN="sign",bt.LENGTH="length",bt.NEGATE="negate",bt.INVERT="invert",bt.MIN="min",bt.MAX="max",bt.MOD="mod",bt.STEP="step",bt.REFLECT="reflect",bt.DISTANCE="distance",bt.DOT="dot",bt.CROSS="cross",bt.POW="pow",bt.MIX="mix",bt.CLAMP="clamp",bt.REFRACT="refract",bt.SMOOTHSTEP="smoothstep",bt.FACEFORWARD="faceforward";var ri=class extends Ot{constructor(t,n,e){super("v4"),this.nodeType="TextureCubeUV",this.value=t,this.uv=n,this.bias=e}bilinearCubeUV(t,n,e,i){let a=new $r(ri.Nodes.bilinearCubeUV,[n,e,i]);this.colorSpaceTL=this.colorSpaceTL??new on(new Gt("","v4")),this.colorSpaceTL.fromDecoding(t.getTextureEncodingFromMap(this.value.value)),this.colorSpaceTL.input.parse(a.build(t)+".tl"),this.colorSpaceTR=this.colorSpaceTR??new on(new Gt("","v4")),this.colorSpaceTR.fromDecoding(t.getTextureEncodingFromMap(this.value.value)),this.colorSpaceTR.input.parse(a.build(t)+".tr"),this.colorSpaceBL=this.colorSpaceBL??new on(new Gt("","v4")),this.colorSpaceBL.fromDecoding(t.getTextureEncodingFromMap(this.value.value)),this.colorSpaceBL.input.parse(a.build(t)+".bl"),this.colorSpaceBR=this.colorSpaceBR??new on(new Gt("","v4")),this.colorSpaceBR.fromDecoding(t.getTextureEncodingFromMap(this.value.value)),this.colorSpaceBR.input.parse(a.build(t)+".br");let r={include:t.isShader("vertex"),ignoreCache:!0};t.addContext(r),this.colorSpaceTLExp=new Gt(this.colorSpaceTL.build(t,"v4"),"v4"),this.colorSpaceTRExp=new Gt(this.colorSpaceTR.build(t,"v4"),"v4"),this.colorSpaceBLExp=new Gt(this.colorSpaceBL.build(t,"v4"),"v4"),this.colorSpaceBRExp=new Gt(this.colorSpaceBR.build(t,"v4"),"v4"),t.removeContext();let o=new Gt("mix( mix( cubeUV_TL, cubeUV_TR, cubeUV.f.x ), mix( cubeUV_BL, cubeUV_BR, cubeUV.f.x ), cubeUV.f.y )","v4");return o.keywords.cubeUV_TL=this.colorSpaceTLExp,o.keywords.cubeUV_TR=this.colorSpaceTRExp,o.keywords.cubeUV_BL=this.colorSpaceBLExp,o.keywords.cubeUV_BR=this.colorSpaceBRExp,o.keywords.cubeUV=a,o}generate(t,n){if(t.isShader("fragment")){let e=this.uv,i=this.bias||t.context.roughness,a=new $r(ri.Nodes.roughnessToMip,[i]),r=new bt(a,ri.Nodes.m0,ri.Nodes.cubeUV_maxMipLevel,bt.CLAMP),o=new bt(r,bt.FLOOR),l=new bt(r,bt.FRACT),u=this.bilinearCubeUV(t,this.value,e,o),c=this.bilinearCubeUV(t,this.value,e,new Oe(o,new Z(1).setReadonly(!0),Oe.ADD)),s=new bt(u,c,l,bt.MIX);return t.format(s.build(t),"v4",n)}return console.warn("TextureCubeUVNode is not compatible with "+t.shader+" shader."),t.format("vec4( 0.0 )",this.getType(t),n)}},_a=ri;_a.Nodes=(function(){let t=new Qo(`struct TextureCubeUVData {
		...
		}`,[t,r,o,n,e,i,a]);l.useKeywords=!1;let u=new Bt("float r0 1.0",!0),c=new Bt("float v0 0.339",!0),s=new Bt("float m0 -2.0",!0),p=new Bt("float r1 0.8",!0),S=new Bt("float v1 0.276",!0),g=new Bt("float m1 -1.0",!0),b=new Bt("float r4 0.4",!0),f=new Bt("float v4 0.046",!0),w=new Bt("float m4 2.0",!0),v=new Bt("float r5 0.305",!0),x=new Bt("float v5 0.016",!0),N=new Bt("float m5 3.0",!0),F=new Bt("float r6 0.21",!0),U=new Bt("float v6 0.0038",!0),M=new Bt("float m6 4.0",!0);return{bilinearCubeUV:l,roughnessToMip:new $(`float roughnessToMip(float roughness) {
			float mip = 0.0;
			if (roughness >= r1) {
...
`)+`
`+r);let N,F,U=x+a+u,M=x+r+c,I=Qr(o,o.VERTEX_SHADER,U),K=Qr(o,o.FRAGMENT_SHADER,M);function P(tt){if(t.debug.checkShaderErrors){let it=o.getProgramInfoLog(v)||"",at=o.getShaderInfoLog(I)||"",X=o.getShaderInfoLog(K)||"",j=it.trim(),k=at.trim(),D=X.trim(),dt=!0,yt=!0;if(o.getProgramParameter(v,o.LINK_STATUS)===!1)if(dt=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(o,v,I,K);else{let qt=eo(o,I,"vertex"),Ft=eo(o,K,"fragment");re("WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(v,o.VALIDATE_STATUS)+`
...
Program Info Log: `+j+`
`+qt+`
`+Ft)}else j!==""?ne("WebGLProgram: Program Info Log:",j):(k===""||D==="")&&(yt=!1);yt&&(tt.diagnostics={runnable:dt,programLog:j,vertexShader:{log:k,prefix:a},fragmentShader:{log:D,prefix:r}})}o.deleteShader(I),o.deleteShader(K),N=new Ai(o,v),F=(function(it,at){let X={},j=it.getProgramParameter(at,it.ACTIVE_ATTRIBUTES);for(let k=0;k<j;k++){let D=it.getActiveAttrib(at,k),dt=D.name,yt=1;D.type===it.FLOAT_MAT2&&(yt=2),D.type===it.FLOAT_MAT3&&(yt=3),D.type===it.FLOAT_MAT4&&(yt=4),X[dt]={type:D.type,location:it.getAttribLocation(at,dt),locationSize:yt}}return X})(o,v)}o.attachShader(v,I),o.attachShader(v,K),e.index0AttributeName!==void 0?o.bindAttribLocation(v,0,e.index0AttributeName):e.hasPositionAttribute===!0&&o.bindAttribLocation(v,0,"position"),o.linkProgram(v),this.getUniforms=function(){return N===void 0&&P(this),N},this.getAttributes=function(){return F===void 0&&P(this),F};let ot=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return ot===!1&&(ot=o.getProgramParameter(v,37297)),ot},this.destroy=function(){i.releaseStatesOfProgram(this),o.deleteProgram(v),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=Wu++,this.cacheKey=n,this.usedTimes=1,this.program=v,this.vertexShader=I,this.fragmentShader=K,this}var ad=0,rd=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,n,e){let i=this._getShaderCacheForMaterial(t);return i.has(n)===!1&&(i.add(n),n.usedTimes++),i.has(e)===!1&&(i.add(e),e.usedTimes++),this}remove(t){let n=this.materialCache.get(t);for(let e of n)e.usedTimes--,e.usedTimes===0&&this.shaderCache.delete(e.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let n=this.materialCache,e=n.get(t);return e===void 0&&(e=new Set,n.set(t,e)),e}_getShaderStage(t){let n=this.shaderCache,e=n.get(t);return e===void 0&&(e=new od(t),n.set(t,e)),e}},od=class{constructor(t){this.id=ad++,this.code=t,this.usedTimes=0}};function sd(t){return t===$n||t===ua||t===da}function ld(t,n,e,i,a,r){let o=new Fl,l=new rd,u=new Set,c=[],s=new Map,p=i.logarithmicDepthBuffer,S=i.precision,g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function b(f){return u.add(f),f===0?"uv":`uv${f}`}return{getParameters:function(f,w,v,x,N,F){let U=x.fog,M=N.geometry,I=f.isMeshStandardMaterial||f.isMeshLambertMaterial||f.isMeshPhongMaterial?x.environment:null,K=f.isMeshStandardMaterial||f.isMeshLambertMaterial&&!f.envMap||f.isMeshPhongMaterial&&!f.envMap,P=n.get(f.envMap||I,K),ot=P&&P.mapping===Vi?P.image.height:null,tt=g[f.type];f.precision!==null&&(S=i.getMaxPrecision(f.precision),S!==f.precision&&ne("WebGLProgram.getParameters:",f.precision,"not supported, using",S,"instead."));let it,at,X,j,k=M.morphAttributes.position||M.morphAttributes.normal||M.morphAttributes.color,D=k!==void 0?k.length:0,dt=0;if(M.morphAttributes.position!==void 0&&(dt=1),M.morphAttributes.normal!==void 0&&(dt=2),M.morphAttributes.color!==void 0&&(dt=3),tt){let Ve=nn[tt];it=Ve.vertexShader,at=Ve.fragmentShader}else{it=f.vertexShader,at=f.fragmentShader;let Ve=l.getVertexShaderStage(f),gn=l.getFragmentShaderStage(f);l.update(f,Ve,gn),X=Ve.id,j=gn.id}let yt=t.getRenderTarget(),qt=t.state.buffers.depth.getReversed(),Ft=N.isInstancedMesh===!0,Ct=N.isBatchedMesh===!0,ae=!!f.map,ue=!!f.matcap,mt=!!P,Nt=!!f.aoMap,Yt=!!f.lightMap,$t=!!f.bumpMap&&f.wireframe===!1,T=!!f.normalMap,m=!!f.displacementMap,y=!!f.emissiveMap,V=!!f.metalnessMap,h=!!f.roughnessMap,R=f.anisotropy>0,A=f.clearcoat>0,_=f.dispersion>0,B=f.iridescence>0,z=f.sheen>0,et=f.transmission>0,q=R&&!!f.anisotropyMap,wt=A&&!!f.clearcoatMap,st=A&&!!f.clearcoatNormalMap,ht=A&&!!f.clearcoatRoughnessMap,W=B&&!!f.iridescenceMap,Xt=B&&!!f.iridescenceThicknessMap,G=z&&!!f.sheenColorMap,Q=z&&!!f.sheenRoughnessMap,Dt=!!f.specularMap,Vt=!!f.specularColorMap,de=!!f.specularIntensityMap,fe=et&&!!f.transmissionMap,we=et&&!!f.thicknessMap,vt=!!f.gradientMap,Ht=!!f.alphaMap,At=f.alphaTest>0,Qt=!!f.alphaHash,te=!!f.extensions,me=mn;f.toneMapped&&(yt===null||yt.isXRRenderTarget===!0)&&(me=t.toneMapping);let He={shaderID:tt,shaderType:f.type,shaderName:f.name,vertexShader:it,fragmentShader:at,defines:f.defines,customVertexShaderID:X,customFragmentShaderID:j,isRawShaderMaterial:f.isRawShaderMaterial===!0,glslVersion:f.glslVersion,precision:S,batching:Ct,batchingColor:Ct&&N._colorsTexture!==null,instancing:Ft,instancingColor:Ft&&N.instanceColor!==null,instancingMorph:Ft&&N.morphTexture!==null,outputColorSpace:yt===null?t.outputColorSpace:yt.isXRRenderTarget===!0?yt.texture.colorSpace:ce.workingColorSpace,alphaToCoverage:!!f.alphaToCoverage,map:ae,matcap:ue,envMap:mt,envMapMode:mt&&P.mapping,envMapCubeUVHeight:ot,aoMap:Nt,lightMap:Yt,bumpMap:$t,normalMap:T,displacementMap:m,emissiveMap:y,normalMapObjectSpace:T&&f.normalMapType===zl,normalMapTangentSpace:T&&f.normalMapType===Lr,packedNormalMap:T&&f.normalMapType===Lr&&sd(f.normalMap.format),metalnessMap:V,roughnessMap:h,anisotropy:R,anisotropyMap:q,clearcoat:A,clearcoatMap:wt,clearcoatNormalMap:st,clearcoatRoughnessMap:ht,dispersion:_,iridescence:B,iridescenceMap:W,iridescenceThicknessMap:Xt,sheen:z,sheenColorMap:G,sheenRoughnessMap:Q,specularMap:Dt,specularColorMap:Vt,specularIntensityMap:de,transmission:et,transmissionMap:fe,thicknessMap:we,gradientMap:vt,opaque:f.transparent===!1&&f.blending===Ci&&f.alphaToCoverage===!1,alphaMap:Ht,alphaTest:At,alphaHash:Qt,combine:f.combine,mapUv:ae&&b(f.map.channel),aoMapUv:Nt&&b(f.aoMap.channel),lightMapUv:Yt&&b(f.lightMap.channel),bumpMapUv:$t&&b(f.bumpMap.channel),normalMapUv:T&&b(f.normalMap.channel),displacementMapUv:m&&b(f.displacementMap.channel),emissiveMapUv:y&&b(f.emissiveMap.channel),metalnessMapUv:V&&b(f.metalnessMap.channel),roughnessMapUv:h&&b(f.roughnessMap.channel),anisotropyMapUv:q&&b(f.anisotropyMap.channel),clearcoatMapUv:wt&&b(f.clearcoatMap.channel),clearcoatNormalMapUv:st&&b(f.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ht&&b(f.clearcoatRoughnessMap.channel),iridescenceMapUv:W&&b(f.iridescenceMap.channel),iridescenceThicknessMapUv:Xt&&b(f.iridescenceThicknessMap.channel),sheenColorMapUv:G&&b(f.sheenColorMap.channel),sheenRoughnessMapUv:Q&&b(f.sheenRoughnessMap.channel),specularMapUv:Dt&&b(f.specularMap.channel),specularColorMapUv:Vt&&b(f.specularColorMap.channel),specularIntensityMapUv:de&&b(f.specularIntensityMap.channel),transmissionMapUv:fe&&b(f.transmissionMap.channel),thicknessMapUv:we&&b(f.thicknessMap.channel),alphaMapUv:Ht&&b(f.alphaMap.channel),vertexTangents:!!M.attributes.tangent&&(T||R),vertexNormals:!!M.attributes.normal,vertexColors:f.vertexColors,vertexAlphas:f.vertexColors===!0&&!!M.attributes.color&&M.attributes.color.itemSize===4,pointsUvs:N.isPoints===!0&&!!M.attributes.uv&&(ae||Ht),fog:!!U,useFog:f.fog===!0,fogExp2:!!U&&U.isFogExp2,flatShading:f.wireframe===!1&&(f.flatShading===!0||M.attributes.normal===void 0&&T===!1&&(f.isMeshLambertMaterial||f.isMeshPhongMaterial||f.isMeshStandardMaterial||f.isMeshPhysicalMaterial)),sizeAttenuation:f.sizeAttenuation===!0,logarithmicDepthBuffer:p,reversedDepthBuffer:qt,skinning:N.isSkinnedMesh===!0,hasPositionAttribute:M.attributes.position!==void 0,morphTargets:M.morphAttributes.position!==void 0,morphNormals:M.morphAttributes.normal!==void 0,morphColors:M.morphAttributes.color!==void 0,morphTargetsCount:D,morphTextureStride:dt,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numLightProbeGrids:F.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:f.dithering,shadowMapEnabled:t.shadowMap.enabled&&v.length>0,shadowMapType:t.shadowMap.type,toneMapping:me,decodeVideoTexture:ae&&f.map.isVideoTexture===!0&&ce.getTransfer(f.map.colorSpace)===Zt,decodeVideoTextureEmissive:y&&f.emissiveMap.isVideoTexture===!0&&ce.getTransfer(f.emissiveMap.colorSpace)===Zt,premultipliedAlpha:f.premultipliedAlpha,doubleSided:f.side===rn,flipSided:f.side===We,useDepthPacking:f.depthPacking>=0,depthPacking:f.depthPacking||0,index0AttributeName:f.index0AttributeName,extensionClipCullDistance:te&&f.extensions.clipCullDistance===!0&&e.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(te&&f.extensions.multiDraw===!0||Ct)&&e.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:e.has("KHR_parallel_shader_compile"),customProgramCacheKey:f.customProgramCacheKey()};return He.vertexUv1s=u.has(1),He.vertexUv2s=u.has(2),He.vertexUv3s=u.has(3),u.clear(),He},getProgramCacheKey:function(f){let w=[];if(f.shaderID?w.push(f.shaderID):(w.push(f.customVertexShaderID),w.push(f.customFragmentShaderID)),f.defines!==void 0)for(let v in f.defines)w.push(v),w.push(f.defines[v]);return f.isRawShaderMaterial===!1&&((function(v,x){v.push(x.precision),v.push(x.outputColorSpace),v.push(x.envMapMode),v.push(x.envMapCubeUVHeight),v.push(x.mapUv),v.push(x.alphaMapUv),v.push(x.lightMapUv),v.push(x.aoMapUv),v.push(x.bumpMapUv),v.push(x.normalMapUv),v.push(x.displacementMapUv),v.push(x.emissiveMapUv),v.push(x.metalnessMapUv),v.push(x.roughnessMapUv),v.push(x.anisotropyMapUv),v.push(x.clearcoatMapUv),v.push(x.clearcoatNormalMapUv),v.push(x.clearcoatRoughnessMapUv),v.push(x.iridescenceMapUv),v.push(x.iridescenceThicknessMapUv),v.push(x.sheenColorMapUv),v.push(x.sheenRoughnessMapUv),v.push(x.specularMapUv),v.push(x.specularColorMapUv),v.push(x.specularIntensityMapUv),v.push(x.transmissionMapUv),v.push(x.thicknessMapUv),v.push(x.combine),v.push(x.fogExp2),v.push(x.sizeAttenuation),v.push(x.morphTargetsCount),v.push(x.morphAttributeCount),v.push(x.numDirLights),v.push(x.numPointLights),v.push(x.numSpotLights),v.push(x.numSpotLightMaps),v.push(x.numHemiLights),v.push(x.numRectAreaLights),v.push(x.numDirLightShadows),v.push(x.numPointLightShadows),v.push(x.numSpotLightShadows),v.push(x.numSpotLightShadowsWithMaps),v.push(x.numLightProbes),v.push(x.shadowMapType),v.push(x.toneMapping),v.push(x.numClippingPlanes),v.push(x.numClipIntersection),v.push(x.depthPacking)})(w,f),(function(v,x){o.disableAll(),x.instancing&&o.enable(0),x.instancingColor&&o.enable(1),x.instancingMorph&&o.enable(2),x.matcap&&o.enable(3),x.envMap&&o.enable(4),x.normalMapObjectSpace&&o.enable(5),x.normalMapTangentSpace&&o.enable(6),x.clearcoat&&o.enable(7),x.iridescence&&o.enable(8),x.alphaTest&&o.enable(9),x.vertexColors&&o.enable(10),x.vertexAlphas&&o.enable(11),x.vertexUv1s&&o.enable(12),x.vertexUv2s&&o.enable(13),x.vertexUv3s&&o.enable(14),x.vertexTangents&&o.enable(15),x.anisotropy&&o.enable(16),x.alphaHash&&o.enable(17),x.batching&&o.enable(18),x.dispersion&&o.enable(19),x.batchingColor&&o.enable(20),x.gradientMap&&o.enable(21),x.packedNormalMap&&o.enable(22),x.vertexNormals&&o.enable(23),v.push(o.mask),o.disableAll(),x.fog&&o.enable(0),x.useFog&&o.enable(1),x.flatShading&&o.enable(2),x.logarithmicDepthBuffer&&o.enable(3),x.reversedDepthBuffer&&o.enable(4),x.skinning&&o.enable(5),x.morphTargets&&o.enable(6),x.morphNormals&&o.enable(7),x.morphColors&&o.enable(8),x.premultipliedAlpha&&o.enable(9),x.shadowMapEnabled&&o.enable(10),x.doubleSided&&o.enable(11),x.flipSided&&o.enable(12),x.useDepthPacking&&o.enable(13),x.dithering&&o.enable(14),x.transmission&&o.enable(15),x.sheen&&o.enable(16),x.opaque&&o.enable(17),x.pointsUvs&&o.enable(18),x.decodeVideoTexture&&o.enable(19),x.decodeVideoTextureEmissive&&o.enable(20),x.alphaToCoverage&&o.enable(21),x.numLightProbeGrids>0&&o.enable(22),x.hasPositionAttribute&&o.enable(23),v.push(o.mask)})(w,f),w.push(t.outputColorSpace)),w.push(f.customProgramCacheKey),w.join()},getUniforms:function(f){let w,v=g[f.type];if(v){let x=nn[v];w=Zn.clone(x.uniforms)}else w=f.uniforms;return w},acquireProgram:function(f,w){let v=s.get(w);return v!==void 0?++v.usedTimes:(v=new id(t,w,f,a),c.push(v),s.set(w,v)),v},releaseProgram:function(f){if(--f.usedTimes===0){let w=c.indexOf(f);c[w]=c[c.length-1],c.pop(),s.delete(f.cacheKey),f.destroy()}},releaseShaderCache:function(f){l.remove(f)},programs:c,dispose:function(){l.dispose()}}}function cd(){let t=new WeakMap;return{has:function(n){return t.has(n)},get:function(n){let e=t.get(n);return e===void 0&&(e={},t.set(n,e)),e},remove:function(n){t.delete(n)},update:function(n,e,i){t.get(n)[e]=i},dispose:function(){t=new WeakMap}}}function ud(t,n){return t.groupOrder!==n.groupOrder?t.groupOrder-n.groupOrder:t.renderOrder!==n.renderOrder?t.renderOrder-n.renderOrder:t.material.id!==n.material.id?t.material.id-n.material.id:t.materialVariant!==n.materialVariant?t.materialVariant-n.materialVariant:t.z!==n.z?t.z-n.z:t.id-n.id}function oo(t,n){return t.groupOrder!==n.groupOrder?t.groupOrder-n.groupOrder:t.renderOrder!==n.renderOrder?t.renderOrder-n.renderOrder:t.z!==n.z?n.z-t.z:t.id-n.id}function so(){let t=[],n=0,e=[],i=[],a=[];function r(l){let u=0;return l.isInstancedMesh&&(u+=2),l.isSkinnedMesh&&(u+=1),u}function o(l,u,c,s,p,S){let g=t[n];return g===void 0?(g={id:l.id,object:l,geometry:u,material:c,materialVariant:r(l),groupOrder:s,renderOrder:l.renderOrder,z:p,group:S},t[n]=g):(g.id=l.id,g.object=l,g.geometry=u,g.material=c,g.materialVariant=r(l),g.groupOrder=s,g.renderOrder=l.renderOrder,g.z=p,g.group=S),n++,g}return{opaque:e,transmissive:i,transparent:a,init:function(){n=0,e.length=0,i.length=0,a.length=0},push:function(l,u,c,s,p,S){let g=o(l,u,c,s,p,S);c.transmission>0?i.push(g):c.transparent===!0?a.push(g):e.push(g)},unshift:function(l,u,c,s,p,S){let g=o(l,u,c,s,p,S);c.transmission>0?i.unshift(g):c.transparent===!0?a.unshift(g):e.unshift(g)},finish:function(){for(let l=n,u=t.length;l<u;l++){let c=t[l];if(c.id===null)break;c.id=null,c.object=null,c.geometry=null,c.material=null,c.group=null}},sort:function(l,u,c){e.length>1&&e.sort(l||ud),i.length>1&&i.sort(u||oo),a.length>1&&a.sort(u||oo),c&&(e.reverse(),i.reverse(),a.reverse())}}}function dd(){let t=new WeakMap;return{get:function(n,e){let i,a=t.get(n);return a===void 0?(i=new so,t.set(n,[i])):e>=a.length?(i=new so,a.push(i)):i=a[e],i},dispose:function(){t=new WeakMap}}}function fd(){let t={};return{get:function(n){if(t[n.id]!==void 0)return t[n.id];let e;switch(n.type){case"DirectionalLight":e={direction:new Mt,color:new oe};break;case"SpotLight":e={position:new Mt,direction:new Mt,color:new oe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new Mt,color:new oe,distance:0,decay:0};break;case"HemisphereLight":e={direction:new Mt,skyColor:new oe,groundColor:new oe};break;case"RectAreaLight":e={color:new oe,position:new Mt,halfWidth:new Mt,halfHeight:new Mt}}return t[n.id]=e,e}}}var pd=0;function hd(t,n){return(n.castShadow?2:0)-(t.castShadow?2:0)+(n.map?1:0)-(t.map?1:0)}function md(t){let n=new fd,e=(function(){let l={};return{get:function(u){if(l[u.id]!==void 0)return l[u.id];let c;switch(u.type){case"DirectionalLight":case"SpotLight":c={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new _t};break;case"PointLight":c={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new _t,shadowCameraNear:1,shadowCameraFar:1e3}}return l[u.id]=c,c}}})(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)i.probe.push(new Mt);let a=new Mt,r=new En,o=new En;return{setup:function(l){let u=0,c=0,s=0;for(let I=0;I<9;I++)i.probe[I].set(0,0,0);let p=0,S=0,g=0,b=0,f=0,w=0,v=0,x=0,N=0,F=0,U=0;l.sort(hd);for(let I=0,K=l.length;I<K;I++){let P=l[I],ot=P.color,tt=P.intensity,it=P.distance,at=null;if(P.shadow&&P.shadow.map&&(at=P.shadow.map.texture.format===$n?P.shadow.map.texture:P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)u+=ot.r*tt,c+=ot.g*tt,s+=ot.b*tt;else if(P.isLightProbe){for(let X=0;X<9;X++)i.probe[X].addScaledVector(P.sh.coefficients[X],tt);U++}else if(P.isDirectionalLight){let X=n.get(P);if(X.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){let j=P.shadow,k=e.get(P);k.shadowIntensity=j.intensity,k.shadowBias=j.bias,k.shadowNormalBias=j.normalBias,k.shadowRadius=j.radius,k.shadowMapSize=j.mapSize,i.directionalShadow[p]=k,i.directionalShadowMap[p]=at,i.directionalShadowMatrix[p]=P.shadow.matrix,w++}i.directional[p]=X,p++}else if(P.isSpotLight){let X=n.get(P);X.position.setFromMatrixPosition(P.matrixWorld),X.color.copy(ot).multiplyScalar(tt),X.distance=it,X.coneCos=Math.cos(P.angle),X.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),X.decay=P.decay,i.spot[g]=X;let j=P.shadow;if(P.map&&(i.spotLightMap[N]=P.map,N++,j.updateMatrices(P),P.castShadow&&F++),i.spotLightMatrix[g]=j.matrix,P.castShadow){let k=e.get(P);k.shadowIntensity=j.intensity,k.shadowBias=j.bias,k.shadowNormalBias=j.normalBias,k.shadowRadius=j.radius,k.shadowMapSize=j.mapSize,i.spotShadow[g]=k,i.spotShadowMap[g]=at,x++}g++}else if(P.isRectAreaLight){let X=n.get(P);X.color.copy(ot).multiplyScalar(tt),X.halfWidth.set(.5*P.width,0,0),X.halfHeight.set(0,.5*P.height,0),i.rectArea[b]=X,b++}else if(P.isPointLight){let X=n.get(P);if(X.color.copy(P.color).multiplyScalar(P.intensity),X.distance=P.distance,X.decay=P.decay,P.castShadow){let j=P.shadow,k=e.get(P);k.shadowIntensity=j.intensity,k.shadowBias=j.bias,k.shadowNormalBias=j.normalBias,k.shadowRadius=j.radius,k.shadowMapSize=j.mapSize,k.shadowCameraNear=j.camera.near,k.shadowCameraFar=j.camera.far,i.pointShadow[S]=k,i.pointShadowMap[S]=at,i.pointShadowMatrix[S]=P.shadow.matrix,v++}i.point[S]=X,S++}else if(P.isHemisphereLight){let X=n.get(P);X.skyColor.copy(P.color).multiplyScalar(tt),X.groundColor.copy(P.groundColor).multiplyScalar(tt),i.hemi[f]=X,f++}}b>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Y.LTC_FLOAT_1,i.rectAreaLTC2=Y.LTC_FLOAT_2):(i.rectAreaLTC1=Y.LTC_HALF_1,i.rectAreaLTC2=Y.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=c,i.ambient[2]=s;let M=i.hash;(M.directionalLength!==p||M.pointLength!==S||M.spotLength!==g||M.rectAreaLength!==b||M.hemiLength!==f||M.numDirectionalShadows!==w||M.numPointShadows!==v||M.numSpotShadows!==x||M.numSpotMaps!==N||M.numLightProbes!==U)&&(i.directional.length=p,i.spot.length=g,i.rectArea.length=b,i.point.length=S,i.hemi.length=f,i.directionalShadow.length=w,i.directionalShadowMap.length=w,i.pointShadow.length=v,i.pointShadowMap.length=v,i.spotShadow.length=x,i.spotShadowMap.length=x,i.directionalShadowMatrix.length=w,i.pointShadowMatrix.length=v,i.spotLightMatrix.length=x+N-F,i.spotLightMap.length=N,i.numSpotLightShadowsWithMaps=F,i.numLightProbes=U,M.directionalLength=p,M.pointLength=S,M.spotLength=g,M.rectAreaLength=b,M.hemiLength=f,M.numDirectionalShadows=w,M.numPointShadows=v,M.numSpotShadows=x,M.numSpotMaps=N,M.numLightProbes=U,i.version=pd++)},setupView:function(l,u){let c=0,s=0,p=0,S=0,g=0,b=u.matrixWorldInverse;for(let f=0,w=l.length;f<w;f++){let v=l[f];if(v.isDirectionalLight){let x=i.directional[c];x.direction.setFromMatrixPosition(v.matrixWorld),a.setFromMatrixPosition(v.target.matrixWorld),x.direction.sub(a),x.direction.transformDirection(b),c++}else if(v.isSpotLight){let x=i.spot[p];x.position.setFromMatrixPosition(v.matrixWorld),x.position.applyMatrix4(b),x.direction.setFromMatrixPosition(v.matrixWorld),a.setFromMatrixPosition(v.target.matrixWorld),x.direction.sub(a),x.direction.transformDirection(b),p++}else if(v.isRectAreaLight){let x=i.rectArea[S];x.position.setFromMatrixPosition(v.matrixWorld),x.position.applyMatrix4(b),o.identity(),r.copy(v.matrixWorld),r.premultiply(b),o.extractRotation(r),x.halfWidth.set(.5*v.width,0,0),x.halfHeight.set(0,.5*v.height,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),S++}else if(v.isPointLight){let x=i.point[s];x.position.setFromMatrixPosition(v.matrixWorld),x.position.applyMatrix4(b),s++}else if(v.isHemisphereLight){let x=i.hemi[g];x.direction.setFromMatrixPosition(v.matrixWorld),x.direction.transformDirection(b),g++}}},state:i}}function lo(t){let n=new md(t),e=[],i=[],a=[],r={lightsArray:e,shadowsArray:i,lightProbeGridArray:a,camera:null,lights:n,transmissionRenderTarget:{},textureUnits:0};return{init:function(o){r.camera=o,e.length=0,i.length=0,a.length=0},state:r,setupLights:function(){n.setup(e)},setupLightsView:function(o){n.setupView(e,o)},pushLight:function(o){e.push(o)},pushShadow:function(o){i.push(o)},pushLightProbeGrid:function(o){a.push(o)}}}function vd(t){let n=new WeakMap;return{get:function(e,i=0){let a,r=n.get(e);return r===void 0?(a=new lo(t),n.set(e,[a])):i>=r.length?(a=new lo(t),r.push(a)):a=r[i],a},dispose:function(){n=new WeakMap}}}var gd=[new Mt(1,0,0),new Mt(-1,0,0),new Mt(0,1,0),new Mt(0,-1,0),new Mt(0,0,1),new Mt(0,0,-1)],_d=[new Mt(0,-1,0),new Mt(0,-1,0),new Mt(0,0,1),new Mt(0,0,-1),new Mt(0,-1,0),new Mt(0,-1,0)],co=new En,ni=new Mt,ra=new Mt;function xd(t,n,e){let i=new Ao,a=new _t,r=new _t,o=new ie,l=new Vl,u=new Hl,c={},s=e.maxTextureSize,p={[ci]:We,[We]:ci,[rn]:rn},S=new _e({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new _t},radius:{value:4}},vertexShader:`void main() {
...
}`}),g=S.clone();g.defines.HORIZONTAL_PASS=1;let b=new ya;b.setAttribute("position",new Gl(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let f=new Xn(b,S),w=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=si;let v=this.type;function x(M,I){let K=n.update(f);S.defines.VSM_SAMPLES!==M.blurSamples&&(S.defines.VSM_SAMPLES=M.blurSamples,g.defines.VSM_SAMPLES=M.blurSamples,S.needsUpdate=!0,g.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new se(a.x,a.y,{format:$n,type:Ye})),S.uniforms.shadow_pass.value=M.map.depthTexture,S.uniforms.resolution.value=M.mapSize,S.uniforms.radius.value=M.radius,t.setRenderTarget(M.mapPass),t.clear(),t.renderBufferDirect(I,null,K,S,f,null),g.uniforms.shadow_pass.value=M.mapPass.texture,g.uniforms.resolution.value=M.mapSize,g.uniforms.radius.value=M.radius,t.setRenderTarget(M.map),t.clear(),t.renderBufferDirect(I,null,K,g,f,null)}function N(M,I,K,P){let ot=null,tt=K.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(tt!==void 0)ot=tt;else if(ot=K.isPointLight===!0?u:l,t.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){let it=ot.uuid,at=I.uuid,X=c[it];X===void 0&&(X={},c[it]=X);let j=X[at];j===void 0&&(j=ot.clone(),X[at]=j,I.addEventListener("dispose",U)),ot=j}return ot.visible=I.visible,ot.wireframe=I.wireframe,ot.side=P===ai?I.shadowSide!==null?I.shadowSide:I.side:I.shadowSide!==null?I.shadowSide:p[I.side],ot.alphaMap=I.alphaMap,ot.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,ot.map=I.map,ot.clipShadows=I.clipShadows,ot.clippingPlanes=I.clippingPlanes,ot.clipIntersection=I.clipIntersection,ot.displacementMap=I.displacementMap,ot.displacementScale=I.displacementScale,ot.displacementBias=I.displacementBias,ot.wireframeLinewidth=I.wireframeLinewidth,ot.linewidth=I.linewidth,K.isPointLight===!0&&ot.isMeshDistanceMaterial===!0&&(t.properties.get(ot).light=K),ot}function F(M,I,K,P,ot){if(M.visible===!1)return;if(M.layers.test(I.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&ot===ai)&&(!M.frustumCulled||i.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,M.matrixWorld);let it=n.update(M),at=M.material;if(Array.isArray(at)){let X=it.groups;for(let j=0,k=X.length;j<k;j++){let D=X[j],dt=at[D.materialIndex];if(dt&&dt.visible){let yt=N(M,dt,P,ot);M.onBeforeShadow(t,M,I,K,it,yt,D),t.renderBufferDirect(K,null,it,yt,M,D),M.onAfterShadow(t,M,I,K,it,yt,D)}}}else if(at.visible){let X=N(M,at,P,ot);M.onBeforeShadow(t,M,I,K,it,X,null),t.renderBufferDirect(K,null,it,X,M,null),M.onAfterShadow(t,M,I,K,it,X,null)}}let tt=M.children;for(let it=0,at=tt.length;it<at;it++)F(tt[it],I,K,P,ot)}function U(M){M.target.removeEventListener("dispose",U);for(let I in c){let K=c[I],P=M.target.uuid;P in K&&(K[P].dispose(),delete K[P])}}this.render=function(M,I,K){if(w.enabled===!1||w.autoUpdate===!1&&w.needsUpdate===!1||M.length===0)return;this.type===kl&&(ne("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=si);let P=t.getRenderTarget(),ot=t.getActiveCubeFace(),tt=t.getActiveMipmapLevel(),it=t.state;it.setBlending(wn),it.buffers.depth.getReversed()===!0?it.buffers.color.setClear(0,0,0,0):it.buffers.color.setClear(1,1,1,1),it.buffers.depth.setTest(!0),it.setScissorTest(!1);let at=v!==this.type;at&&I.traverse(function(X){X.material&&(Array.isArray(X.material)?X.material.forEach(j=>j.needsUpdate=!0):X.material.needsUpdate=!0)});for(let X=0,j=M.length;X<j;X++){let k=M[X],D=k.shadow;if(D===void 0){ne("WebGLShadowMap:",k,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;a.copy(D.mapSize);let dt=D.getFrameExtents();a.multiply(dt),r.copy(D.mapSize),(a.x>s||a.y>s)&&(a.x>s&&(r.x=Math.floor(s/dt.x),a.x=r.x*dt.x,D.mapSize.x=r.x),a.y>s&&(r.y=Math.floor(s/dt.y),a.y=r.y*dt.y,D.mapSize.y=r.y));let yt=t.state.buffers.depth.getReversed();if(D.camera._reversedDepth=yt,D.map===null||at===!0){if(D.map!==null&&(D.map.depthTexture!==null&&(D.map.depthTexture.dispose(),D.map.depthTexture=null),D.map.dispose()),this.type===ai){if(k.isPointLight){ne("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}D.map=new se(a.x,a.y,{format:$n,type:Ye,minFilter:jt,magFilter:jt,generateMipmaps:!1}),D.map.texture.name=k.name+".shadowMap",D.map.depthTexture=new vn(a.x,a.y,ze),D.map.depthTexture.name=k.name+".shadowMapDepth",D.map.depthTexture.format=di,D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=Se,D.map.depthTexture.magFilter=Se}else k.isPointLight?(D.map=new is(a.x),D.map.depthTexture=new Wl(a.x,Dn)):(D.map=new se(a.x,a.y),D.map.depthTexture=new vn(a.x,a.y,Dn)),D.map.depthTexture.name=k.name+".shadowMap",D.map.depthTexture.format=di,this.type===si?(D.map.depthTexture.compareFunction=yt?Ca:Ra,D.map.depthTexture.minFilter=jt,D.map.depthTexture.magFilter=jt):(D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=Se,D.map.depthTexture.magFilter=Se);D.camera.updateProjectionMatrix()}let qt=D.map.isWebGLCubeRenderTarget?6:1;for(let Ft=0;Ft<qt;Ft++){if(D.map.isWebGLCubeRenderTarget)t.setRenderTarget(D.map,Ft),t.clear();else{Ft===0&&(t.setRenderTarget(D.map),t.clear());let Ct=D.getViewport(Ft);o.set(r.x*Ct.x,r.y*Ct.y,r.x*Ct.z,r.y*Ct.w),it.viewport(o)}if(k.isPointLight){let Ct=D.camera,ae=D.matrix,ue=k.distance||Ct.far;ue!==Ct.far&&(Ct.far=ue,Ct.updateProjectionMatrix()),ni.setFromMatrixPosition(k.matrixWorld),Ct.position.copy(ni),ra.copy(Ct.position),ra.add(gd[Ft]),Ct.up.copy(_d[Ft]),Ct.lookAt(ra),Ct.updateMatrixWorld(),ae.makeTranslation(-ni.x,-ni.y,-ni.z),co.multiplyMatrices(Ct.projectionMatrix,Ct.matrixWorldInverse),D._frustum.setFromProjectionMatrix(co,Ct.coordinateSystem,Ct.reversedDepth)}else D.updateMatrices(k);i=D.getFrustum(),F(I,K,D.camera,k,this.type)}D.isPointLightShadow!==!0&&this.type===ai&&x(D,K),D.needsUpdate=!1}v=this.type,w.needsUpdate=!1,t.setRenderTarget(P,ot,tt)}}function Sd(t,n){let e=new function(){let h=!1,R=new ie,A=null,_=new ie(0,0,0,0);return{setMask:function(B){A!==B&&!h&&(t.colorMask(B,B,B,B),A=B)},setLocked:function(B){h=B},setClear:function(B,z,et,q,wt){wt===!0&&(B*=q,z*=q,et*=q),R.set(B,z,et,q),_.equals(R)===!1&&(t.clearColor(B,z,et,q),_.copy(R))},reset:function(){h=!1,A=null,_.set(-1,0,0,0)}}},i=new function(){let h=!1,R=!1,A=null,_=null,B=null;return{setReversed:function(z){if(R!==z){let et=n.get("EXT_clip_control");z?et.clipControlEXT(et.LOWER_LEFT_EXT,et.ZERO_TO_ONE_EXT):et.clipControlEXT(et.LOWER_LEFT_EXT,et.NEGATIVE_ONE_TO_ONE_EXT),R=z;let q=B;B=null,this.setClear(q)}},getReversed:function(){return R},setTest:function(z){z?mt(t.DEPTH_TEST):Nt(t.DEPTH_TEST)},setMask:function(z){A!==z&&!h&&(t.depthMask(z),A=z)},setFunc:function(z){if(R&&(z=cc[z]),_!==z){switch(z){case Zl:t.depthFunc(t.NEVER);break;case Kl:t.depthFunc(t.ALWAYS);break;case Yl:t.depthFunc(t.LESS);break;case Dr:t.depthFunc(t.LEQUAL);break;case ql:t.depthFunc(t.EQUAL);break;case jl:t.depthFunc(t.GEQUAL);break;case Xl:t.depthFunc(t.GREATER);break;case $l:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}_=z}},setLocked:function(z){h=z},setClear:function(z){B!==z&&(B=z,R&&(z=1-z),t.clearDepth(z))},reset:function(){h=!1,A=null,_=null,B=null,R=!1}}},a=new function(){let h=!1,R=null,A=null,_=null,B=null,z=null,et=null,q=null,wt=null;return{setTest:function(st){h||(st?mt(t.STENCIL_TEST):Nt(t.STENCIL_TEST))},setMask:function(st){R!==st&&!h&&(t.stencilMask(st),R=st)},setFunc:function(st,ht,W){(A!==st||_!==ht||B!==W)&&(t.stencilFunc(st,ht,W),A=st,_=ht,B=W)},setOp:function(st,ht,W){(z!==st||et!==ht||q!==W)&&(t.stencilOp(st,ht,W),z=st,et=ht,q=W)},setLocked:function(st){h=st},setClear:function(st){wt!==st&&(t.clearStencil(st),wt=st)},reset:function(){h=!1,R=null,A=null,_=null,B=null,z=null,et=null,q=null,wt=null}}},r=new WeakMap,o=new WeakMap,l={},u={},c={},s=new WeakMap,p=[],S=null,g=!1,b=null,f=null,w=null,v=null,x=null,N=null,F=null,U=new oe(0,0,0),M=0,I=!1,K=null,P=null,ot=null,tt=null,it=null,at=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS),X=!1,j=0,k=t.getParameter(t.VERSION);k.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(k)[1]),X=j>=1):k.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),X=j>=2);let D=null,dt={},yt=t.getParameter(t.SCISSOR_BOX),qt=t.getParameter(t.VIEWPORT),Ft=new ie().fromArray(yt),Ct=new ie().fromArray(qt);function ae(h,R,A,_){let B=new Uint8Array(4),z=t.createTexture();t.bindTexture(h,z),t.texParameteri(h,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(h,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let et=0;et<A;et++)h===t.TEXTURE_3D||h===t.TEXTURE_2D_ARRAY?t.texImage3D(R,0,t.RGBA,1,1,_,0,t.RGBA,t.UNSIGNED_BYTE,B):t.texImage2D(R+et,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,B);return z}let ue={};function mt(h){l[h]!==!0&&(t.enable(h),l[h]=!0)}function Nt(h){l[h]!==!1&&(t.disable(h),l[h]=!1)}ue[t.TEXTURE_2D]=ae(t.TEXTURE_2D,t.TEXTURE_2D,1),ue[t.TEXTURE_CUBE_MAP]=ae(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ue[t.TEXTURE_2D_ARRAY]=ae(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ue[t.TEXTURE_3D]=ae(t.TEXTURE_3D,t.TEXTURE_3D,1,1),e.setClear(0,0,0,1),i.setClear(1),a.setClear(0),mt(t.DEPTH_TEST),i.setFunc(Dr),m(!1),y(Ur),mt(t.CULL_FACE),T(wn);let Yt={[ti]:t.FUNC_ADD,[pl]:t.FUNC_SUBTRACT,[fl]:t.FUNC_REVERSE_SUBTRACT};Yt[uc]=t.MIN,Yt[dc]=t.MAX;let $t={[Rl]:t.ZERO,[Cl]:t.ONE,[yl]:t.SRC_COLOR,[Ml]:t.SRC_ALPHA,[El]:t.SRC_ALPHA_SATURATE,[wl]:t.DST_COLOR,[bl]:t.DST_ALPHA,[Tl]:t.ONE_MINUS_SRC_COLOR,[Sl]:t.ONE_MINUS_SRC_ALPHA,[xl]:t.ONE_MINUS_DST_COLOR,[_l]:t.ONE_MINUS_DST_ALPHA,[gl]:t.CONSTANT_COLOR,[vl]:t.ONE_MINUS_CONSTANT_COLOR,[ml]:t.CONSTANT_ALPHA,[hl]:t.ONE_MINUS_CONSTANT_ALPHA};function T(h,R,A,_,B,z,et,q,wt,st){if(h!==wn){if(g===!1&&(mt(t.BLEND),g=!0),h===tc)B=B||R,z=z||A,et=et||_,(R!==f||B!==x)&&(t.blendEquationSeparate(Yt[R],Yt[B]),f=R,x=B),(A!==w||_!==v||z!==N||et!==F)&&(t.blendFuncSeparate($t[A],$t[_],$t[z],$t[et]),w=A,v=_,N=z,F=et),(q.equals(U)===!1||wt!==M)&&(t.blendColor(q.r,q.g,q.b,wt),U.copy(q),M=wt),b=h,I=!1;else if(h!==b||st!==I){if((f!==ti||x!==ti)&&(t.blendEquation(t.FUNC_ADD),f=ti,x=ti),st)switch(h){case Ci:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Or:t.blendFunc(t.ONE,t.ONE);break;case Ir:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Nr:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:re("WebGLState: Invalid blending: ",h)}else switch(h){case Ci:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Or:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Ir:re("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Nr:re("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:re("WebGLState: Invalid blending: ",h)}w=null,v=null,N=null,F=null,U.set(0,0,0),M=0,b=h,I=st}}else g===!0&&(Nt(t.BLEND),g=!1)}function m(h){K!==h&&(h?t.frontFace(t.CW):t.frontFace(t.CCW),K=h)}function y(h){h!==Jl?(mt(t.CULL_FACE),h!==P&&(h===Ur?t.cullFace(t.BACK):h===Ql?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Nt(t.CULL_FACE),P=h}function V(h,R,A){h?(mt(t.POLYGON_OFFSET_FILL),(tt!==R||it!==A)&&(tt=R,it=A,i.getReversed()&&(R=-R),t.polygonOffset(R,A))):Nt(t.POLYGON_OFFSET_FILL)}return{buffers:{color:e,depth:i,stencil:a},enable:mt,disable:Nt,bindFramebuffer:function(h,R){return c[h]!==R&&(t.bindFramebuffer(h,R),c[h]=R,h===t.DRAW_FRAMEBUFFER&&(c[t.FRAMEBUFFER]=R),h===t.FRAMEBUFFER&&(c[t.DRAW_FRAMEBUFFER]=R),!0)},drawBuffers:function(h,R){let A=p,_=!1;if(h){A=s.get(R),A===void 0&&(A=[],s.set(R,A));let B=h.textures;if(A.length!==B.length||A[0]!==t.COLOR_ATTACHMENT0){for(let z=0,et=B.length;z<et;z++)A[z]=t.COLOR_ATTACHMENT0+z;A.length=B.length,_=!0}}else A[0]!==t.BACK&&(A[0]=t.BACK,_=!0);_&&t.drawBuffers(A)},useProgram:function(h){return S!==h&&(t.useProgram(h),S=h,!0)},setBlending:T,setMaterial:function(h,R){h.side===rn?Nt(t.CULL_FACE):mt(t.CULL_FACE);let A=h.side===We;R&&(A=!A),m(A),h.blending===Ci&&h.transparent===!1?T(wn):T(h.blending,h.blendEquation,h.blendSrc,h.blendDst,h.blendEquationAlpha,h.blendSrcAlpha,h.blendDstAlpha,h.blendColor,h.blendAlpha,h.premultipliedAlpha),i.setFunc(h.depthFunc),i.setTest(h.depthTest),i.setMask(h.depthWrite),e.setMask(h.colorWrite);let _=h.stencilWrite;a.setTest(_),_&&(a.setMask(h.stencilWriteMask),a.setFunc(h.stencilFunc,h.stencilRef,h.stencilFuncMask),a.setOp(h.stencilFail,h.stencilZFail,h.stencilZPass)),V(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits),h.alphaToCoverage===!0?mt(t.SAMPLE_ALPHA_TO_COVERAGE):Nt(t.SAMPLE_ALPHA_TO_COVERAGE)},setFlipSided:m,setCullFace:y,setLineWidth:function(h){h!==ot&&(X&&t.lineWidth(h),ot=h)},setPolygonOffset:V,setScissorTest:function(h){h?mt(t.SCISSOR_TEST):Nt(t.SCISSOR_TEST)},activeTexture:function(h){h===void 0&&(h=t.TEXTURE0+at-1),D!==h&&(t.activeTexture(h),D=h)},bindTexture:function(h,R,A){A===void 0&&(A=D===null?t.TEXTURE0+at-1:D);let _=dt[A];_===void 0&&(_={type:void 0,texture:void 0},dt[A]=_),(_.type!==h||_.texture!==R)&&(D!==A&&(t.activeTexture(A),D=A),t.bindTexture(h,R||ue[h]),_.type=h,_.texture=R)},unbindTexture:function(){let h=dt[D];h!==void 0&&h.type!==void 0&&(t.bindTexture(h.type,null),h.type=void 0,h.texture=void 0)},compressedTexImage2D:function(){try{t.compressedTexImage2D(...arguments)}catch(h){re("WebGLState:",h)}},compressedTexImage3D:function(){try{t.compressedTexImage3D(...arguments)}catch(h){re("WebGLState:",h)}},texImage2D:function(){try{t.texImage2D(...arguments)}catch(h){re("WebGLState:",h)}},texImage3D:function(){try{t.texImage3D(...arguments)}catch(h){re("WebGLState:",h)}},pixelStorei:function(h,R){u[h]!==R&&(t.pixelStorei(h,R),u[h]=R)},getParameter:function(h){return u[h]!==void 0?u[h]:t.getParameter(h)},updateUBOMapping:function(h,R){let A=o.get(R);A===void 0&&(A=new WeakMap,o.set(R,A));let _=A.get(h);_===void 0&&(_=t.getUniformBlockIndex(R,h.name),A.set(h,_))},uniformBlockBinding:function(h,R){let A=o.get(R).get(h);r.get(R)!==A&&(t.uniformBlockBinding(R,A,h.__bindingPointIndex),r.set(R,A))},texStorage2D:function(){try{t.texStorage2D(...arguments)}catch(h){re("WebGLState:",h)}},texStorage3D:function(){try{t.texStorage3D(...arguments)}catch(h){re("WebGLState:",h)}},texSubImage2D:function(){try{t.texSubImage2D(...arguments)}catch(h){re("WebGLState:",h)}},texSubImage3D:function(){try{t.texSubImage3D(...arguments)}catch(h){re("WebGLState:",h)}},compressedTexSubImage2D:function(){try{t.compressedTexSubImage2D(...arguments)}catch(h){re("WebGLState:",h)}},compressedTexSubImage3D:function(){try{t.compressedTexSubImage3D(...arguments)}catch(h){re("WebGLState:",h)}},scissor:function(h){Ft.equals(h)===!1&&(t.scissor(h.x,h.y,h.z,h.w),Ft.copy(h))},viewport:function(h){Ct.equals(h)===!1&&(t.viewport(h.x,h.y,h.z,h.w),Ct.copy(h))},reset:function(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),i.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),l={},u={},D=null,dt={},c={},s=new WeakMap,p=[],S=null,g=!1,b=null,f=null,w=null,v=null,x=null,N=null,F=null,U=new oe(0,0,0),M=0,I=!1,K=null,P=null,ot=null,tt=null,it=null,Ft.set(0,0,t.canvas.width,t.canvas.height),Ct.set(0,0,t.canvas.width,t.canvas.height),e.reset(),i.reset(),a.reset()}}}function Td(t,n,e,i,a,r,o){let l,u=n.has("WEBGL_multisampled_render_to_texture")?n.get("WEBGL_multisampled_render_to_texture"):null,c=!(typeof navigator>"u")&&/OculusBrowser/g.test(navigator.userAgent),s=new _t,p=new WeakMap,S=new Set,g=new WeakMap,b=!1;try{b=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function f(T,m){return b?new OffscreenCanvas(T,m):pc("canvas")}function w(T,m,y){let V=1,h=$t(T);if((h.width>y||h.height>y)&&(V=y/Math.max(h.width,h.height)),V<1){if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let R=Math.floor(V*h.width),A=Math.floor(V*h.height);l===void 0&&(l=f(R,A));let _=m?f(R,A):l;return _.width=R,_.height=A,_.getContext("2d").drawImage(T,0,0,R,A),ne("WebGLRenderer: Texture has been resized from ("+h.width+"x"+h.height+") to ("+R+"x"+A+")."),_}return"data"in T&&ne("WebGLRenderer: Image in DataTexture is too big ("+h.width+"x"+h.height+")."),T}return T}function v(T){return T.generateMipmaps}function x(T){t.generateMipmap(T)}function N(T){return T.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?t.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function F(T,m,y,V,h,R=!1){if(T!==null){if(t[T]!==void 0)return t[T];ne("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let A;V&&(A=n.get("EXT_texture_norm16"),A||ne("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let _=m;if(m===t.RED&&(y===t.FLOAT&&(_=t.R32F),y===t.HALF_FLOAT&&(_=t.R16F),y===t.UNSIGNED_BYTE&&(_=t.R8),y===t.UNSIGNED_SHORT&&A&&(_=A.R16_EXT),y===t.SHORT&&A&&(_=A.R16_SNORM_EXT)),m===t.RED_INTEGER&&(y===t.UNSIGNED_BYTE&&(_=t.R8UI),y===t.UNSIGNED_SHORT&&(_=t.R16UI),y===t.UNSIGNED_INT&&(_=t.R32UI),y===t.BYTE&&(_=t.R8I),y===t.SHORT&&(_=t.R16I),y===t.INT&&(_=t.R32I)),m===t.RG&&(y===t.FLOAT&&(_=t.RG32F),y===t.HALF_FLOAT&&(_=t.RG16F),y===t.UNSIGNED_BYTE&&(_=t.RG8),y===t.UNSIGNED_SHORT&&A&&(_=A.RG16_EXT),y===t.SHORT&&A&&(_=A.RG16_SNORM_EXT)),m===t.RG_INTEGER&&(y===t.UNSIGNED_BYTE&&(_=t.RG8UI),y===t.UNSIGNED_SHORT&&(_=t.RG16UI),y===t.UNSIGNED_INT&&(_=t.RG32UI),y===t.BYTE&&(_=t.RG8I),y===t.SHORT&&(_=t.RG16I),y===t.INT&&(_=t.RG32I)),m===t.RGB_INTEGER&&(y===t.UNSIGNED_BYTE&&(_=t.RGB8UI),y===t.UNSIGNED_SHORT&&(_=t.RGB16UI),y===t.UNSIGNED_INT&&(_=t.RGB32UI),y===t.BYTE&&(_=t.RGB8I),y===t.SHORT&&(_=t.RGB16I),y===t.INT&&(_=t.RGB32I)),m===t.RGBA_INTEGER&&(y===t.UNSIGNED_BYTE&&(_=t.RGBA8UI),y===t.UNSIGNED_SHORT&&(_=t.RGBA16UI),y===t.UNSIGNED_INT&&(_=t.RGBA32UI),y===t.BYTE&&(_=t.RGBA8I),y===t.SHORT&&(_=t.RGBA16I),y===t.INT&&(_=t.RGBA32I)),m===t.RGB&&(y===t.UNSIGNED_SHORT&&A&&(_=A.RGB16_EXT),y===t.SHORT&&A&&(_=A.RGB16_SNORM_EXT),y===t.UNSIGNED_INT_5_9_9_9_REV&&(_=t.RGB9_E5),y===t.UNSIGNED_INT_10F_11F_11F_REV&&(_=t.R11F_G11F_B10F)),m===t.RGBA){let B=R?Ho:ce.getTransfer(h);y===t.FLOAT&&(_=t.RGBA32F),y===t.HALF_FLOAT&&(_=t.RGBA16F),y===t.UNSIGNED_BYTE&&(_=B===Zt?t.SRGB8_ALPHA8:t.RGBA8),y===t.UNSIGNED_SHORT&&A&&(_=A.RGBA16_EXT),y===t.SHORT&&A&&(_=A.RGBA16_SNORM_EXT),y===t.UNSIGNED_SHORT_4_4_4_4&&(_=t.RGBA4),y===t.UNSIGNED_SHORT_5_5_5_1&&(_=t.RGB5_A1)}return(_===t.R16F||_===t.R32F||_===t.RG16F||_===t.RG32F||_===t.RGBA16F||_===t.RGBA32F)&&n.get("EXT_color_buffer_float"),_}function U(T,m){let y;return T?m===null||m===Dn||m===ui?y=t.DEPTH24_STENCIL8:m===ze?y=t.DEPTH32F_STENCIL8:m===Li&&(y=t.DEPTH24_STENCIL8,ne("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Dn||m===ui?y=t.DEPTH_COMPONENT24:m===ze?y=t.DEPTH_COMPONENT32F:m===Li&&(y=t.DEPTH_COMPONENT16),y}function M(T,m){return v(T)===!0||T.isFramebufferTexture&&T.minFilter!==Se&&T.minFilter!==jt?Math.log2(Math.max(m.width,m.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?m.mipmaps.length:1}function I(T){let m=T.target;m.removeEventListener("dispose",I),(function(y){let V=i.get(y);if(V.__webglInit===void 0)return;let h=y.source,R=g.get(h);if(R){let A=R[V.__cacheKey];A.usedTimes--,A.usedTimes===0&&P(y),Object.keys(R).length===0&&g.delete(h)}i.remove(y)})(m),m.isVideoTexture&&p.delete(m),m.isHTMLTexture&&S.delete(m)}function K(T){let m=T.target;m.removeEventListener("dispose",K),(function(y){let V=i.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),i.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let R=0;R<6;R++){if(Array.isArray(V.__webglFramebuffer[R]))for(let A=0;A<V.__webglFramebuffer[R].length;A++)t.deleteFramebuffer(V.__webglFramebuffer[R][A]);else t.deleteFramebuffer(V.__webglFramebuffer[R]);V.__webglDepthbuffer&&t.deleteRenderbuffer(V.__webglDepthbuffer[R])}else{if(Array.isArray(V.__webglFramebuffer))for(let R=0;R<V.__webglFramebuffer.length;R++)t.deleteFramebuffer(V.__webglFramebuffer[R]);else t.deleteFramebuffer(V.__webglFramebuffer);if(V.__webglDepthbuffer&&t.deleteRenderbuffer(V.__webglDepthbuffer),V.__webglMultisampledFramebuffer&&t.deleteFramebuffer(V.__webglMultisampledFramebuffer),V.__webglColorRenderbuffer)for(let R=0;R<V.__webglColorRenderbuffer.length;R++)V.__webglColorRenderbuffer[R]&&t.deleteRenderbuffer(V.__webglColorRenderbuffer[R]);V.__webglDepthRenderbuffer&&t.deleteRenderbuffer(V.__webglDepthRenderbuffer)}let h=y.textures;for(let R=0,A=h.length;R<A;R++){let _=i.get(h[R]);_.__webglTexture&&(t.deleteTexture(_.__webglTexture),o.memory.textures--),i.remove(h[R])}i.remove(y)})(m)}function P(T){let m=i.get(T);t.deleteTexture(m.__webglTexture);let y=T.source;delete g.get(y)[m.__cacheKey],o.memory.textures--}let ot=0;function tt(T,m){let y=i.get(T);if(T.isVideoTexture&&(function(V){let h=o.render.frame;p.get(V)!==h&&(p.set(V,h),V.update())})(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&y.__version!==T.version){let V=T.image;if(V===null)ne("WebGLRenderer: Texture marked for update but no image data found.");else{if(V.complete!==!1)return void dt(y,T,m);ne("WebGLRenderer: Texture marked for update but image is incomplete")}}else T.isExternalTexture&&(y.__webglTexture=T.sourceTexture?T.sourceTexture:null);e.bindTexture(t.TEXTURE_2D,y.__webglTexture,t.TEXTURE0+m)}let it={[ii]:t.REPEAT,[Re]:t.CLAMP_TO_EDGE,[Al]:t.MIRRORED_REPEAT},at={[Se]:t.NEAREST,[Pl]:t.NEAREST_MIPMAP_NEAREST,[bi]:t.NEAREST_MIPMAP_LINEAR,[jt]:t.LINEAR,[ea]:t.LINEAR_MIPMAP_NEAREST,[Pn]:t.LINEAR_MIPMAP_LINEAR},X={[Ol]:t.NEVER,[Il]:t.ALWAYS,[Nl]:t.LESS,[Ra]:t.LEQUAL,[Ul]:t.EQUAL,[Ca]:t.GEQUAL,[Ll]:t.GREATER,[Dl]:t.NOTEQUAL};function j(T,m){if(m.type===ze&&n.has("OES_texture_float_linear")===!1&&(m.magFilter===jt||m.magFilter===ea||m.magFilter===bi||m.magFilter===Pn||m.minFilter===jt||m.minFilter===ea||m.minFilter===bi||m.minFilter===Pn)&&ne("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(T,t.TEXTURE_WRAP_S,it[m.wrapS]),t.texParameteri(T,t.TEXTURE_WRAP_T,it[m.wrapT]),(T===t.TEXTURE_3D||T===t.TEXTURE_2D_ARRAY)&&t.texParameteri(T,t.TEXTURE_WRAP_R,it[m.wrapR]),t.texParameteri(T,t.TEXTURE_MAG_FILTER,at[m.magFilter]),t.texParameteri(T,t.TEXTURE_MIN_FILTER,at[m.minFilter]),m.compareFunction&&(t.texParameteri(T,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(T,t.TEXTURE_COMPARE_FUNC,X[m.compareFunction])),n.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===Se||m.minFilter!==bi&&m.minFilter!==Pn||m.type===ze&&n.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){let y=n.get("EXT_texture_filter_anisotropic");t.texParameterf(T,y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,a.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function k(T,m){let y=!1;T.__webglInit===void 0&&(T.__webglInit=!0,m.addEventListener("dispose",I));let V=m.source,h=g.get(V);h===void 0&&(h={},g.set(V,h));let R=(function(A){let _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()})(m);if(R!==T.__cacheKey){h[R]===void 0&&(h[R]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,y=!0),h[R].usedTimes++;let A=h[T.__cacheKey];A!==void 0&&(h[T.__cacheKey].usedTimes--,A.usedTimes===0&&P(m)),T.__cacheKey=R,T.__webglTexture=h[R].texture}return y}function D(T,m,y){return Math.floor(Math.floor(T/y)/m)}function dt(T,m,y){let V=t.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(V=t.TEXTURE_2D_ARRAY),m.isData3DTexture&&(V=t.TEXTURE_3D);let h=k(T,m),R=m.source;e.bindTexture(V,T.__webglTexture,t.TEXTURE0+y);let A=i.get(R);if(R.version!==A.__version||h===!0){if(e.activeTexture(t.TEXTURE0+y),(typeof ImageBitmap<"u"&&m.image instanceof ImageBitmap)==0){let G=ce.getPrimaries(ce.workingColorSpace),Q=m.colorSpace===Bn?null:ce.getPrimaries(m.colorSpace),Dt=m.colorSpace===Bn||G===Q?t.NONE:t.BROWSER_DEFAULT_WEBGL;e.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,m.flipY),e.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),e.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Dt)}e.pixelStorei(t.UNPACK_ALIGNMENT,m.unpackAlignment);let _=w(m.image,!1,a.maxTextureSize);_=Yt(m,_);let B=r.convert(m.format,m.colorSpace),z=r.convert(m.type),et=F(m.internalFormat,B,z,m.normalized,m.colorSpace,m.isVideoTexture);j(V,m);let q,wt=m.mipmaps,st=m.isVideoTexture!==!0,ht=A.__version===void 0||h===!0,W=R.dataReady,Xt=M(m,_);if(m.isDepthTexture)et=U(m.format===kn,m.type),ht&&(st?e.texStorage2D(t.TEXTURE_2D,1,et,_.width,_.height):e.texImage2D(t.TEXTURE_2D,0,et,_.width,_.height,0,B,z,null));else if(m.isDataTexture)if(wt.length>0){st&&ht&&e.texStorage2D(t.TEXTURE_2D,Xt,et,wt[0].width,wt[0].height);for(let G=0,Q=wt.length;G<Q;G++)q=wt[G],st?W&&e.texSubImage2D(t.TEXTURE_2D,G,0,0,q.width,q.height,B,z,q.data):e.texImage2D(t.TEXTURE_2D,G,et,q.width,q.height,0,B,z,q.data);m.generateMipmaps=!1}else st?(ht&&e.texStorage2D(t.TEXTURE_2D,Xt,et,_.width,_.height),W&&(function(G,Q,Dt,Vt){let de=G.updateRanges;if(de.length===0)e.texSubImage2D(t.TEXTURE_2D,0,0,0,Q.width,Q.height,Dt,Vt,Q.data);else{de.sort((At,Qt)=>At.start-Qt.start);let fe=0;for(let At=1;At<de.length;At++){let Qt=de[fe],te=de[At],me=Qt.start+Qt.count,He=D(te.start,Q.width,4),Ve=D(Qt.start,Q.width,4);te.start<=me+1&&He===Ve&&D(te.start+te.count-1,Q.width,4)===He?Qt.count=Math.max(Qt.count,te.start+te.count-Qt.start):(++fe,de[fe]=te)}de.length=fe+1;let we=e.getParameter(t.UNPACK_ROW_LENGTH),vt=e.getParameter(t.UNPACK_SKIP_PIXELS),Ht=e.getParameter(t.UNPACK_SKIP_ROWS);e.pixelStorei(t.UNPACK_ROW_LENGTH,Q.width);for(let At=0,Qt=de.length;At<Qt;At++){let te=de[At],me=Math.floor(te.start/4),He=Math.ceil(te.count/4),Ve=me%Q.width,gn=Math.floor(me/Q.width),$e=He;e.pixelStorei(t.UNPACK_SKIP_PIXELS,Ve),e.pixelStorei(t.UNPACK_SKIP_ROWS,gn),e.texSubImage2D(t.TEXTURE_2D,0,Ve,gn,$e,1,Dt,Vt,Q.data)}G.clearUpdateRanges(),e.pixelStorei(t.UNPACK_ROW_LENGTH,we),e.pixelStorei(t.UNPACK_SKIP_PIXELS,vt),e.pixelStorei(t.UNPACK_SKIP_ROWS,Ht)}})(m,_,B,z)):e.texImage2D(t.TEXTURE_2D,0,et,_.width,_.height,0,B,z,_.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){st&&ht&&e.texStorage3D(t.TEXTURE_2D_ARRAY,Xt,et,wt[0].width,wt[0].height,_.depth);for(let G=0,Q=wt.length;G<Q;G++)if(q=wt[G],m.format!==bn)if(B!==null)if(st){if(W)if(m.layerUpdates.size>0){let Dt=Fr(q.width,q.height,m.format,m.type);for(let Vt of m.layerUpdates){let de=q.data.subarray(Vt*Dt/q.data.BYTES_PER_ELEMENT,(Vt+1)*Dt/q.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,G,0,0,Vt,q.width,q.height,1,B,de)}m.clearLayerUpdates()}else e.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,G,0,0,0,q.width,q.height,_.depth,B,q.data)}else e.compressedTexImage3D(t.TEXTURE_2D_ARRAY,G,et,q.width,q.height,_.depth,0,q.data,0,0);else ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else st?W&&e.texSubImage3D(t.TEXTURE_2D_ARRAY,G,0,0,0,q.width,q.height,_.depth,B,z,q.data):e.texImage3D(t.TEXTURE_2D_ARRAY,G,et,q.width,q.height,_.depth,0,B,z,q.data)}else{st&&ht&&e.texStorage2D(t.TEXTURE_2D,Xt,et,wt[0].width,wt[0].height);for(let G=0,Q=wt.length;G<Q;G++)q=wt[G],m.format!==bn?B!==null?st?W&&e.compressedTexSubImage2D(t.TEXTURE_2D,G,0,0,q.width,q.height,B,q.data):e.compressedTexImage2D(t.TEXTURE_2D,G,et,q.width,q.height,0,q.data):ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):st?W&&e.texSubImage2D(t.TEXTURE_2D,G,0,0,q.width,q.height,B,z,q.data):e.texImage2D(t.TEXTURE_2D,G,et,q.width,q.height,0,B,z,q.data)}else if(m.isDataArrayTexture)if(st){if(ht&&e.texStorage3D(t.TEXTURE_2D_ARRAY,Xt,et,_.width,_.height,_.depth),W)if(m.layerUpdates.size>0){let G=Fr(_.width,_.height,m.format,m.type);for(let Q of m.layerUpdates){let Dt=_.data.subarray(Q*G/_.data.BYTES_PER_ELEMENT,(Q+1)*G/_.data.BYTES_PER_ELEMENT);e.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,Q,_.width,_.height,1,B,z,Dt)}m.clearLayerUpdates()}else e.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,_.width,_.height,_.depth,B,z,_.data)}else e.texImage3D(t.TEXTURE_2D_ARRAY,0,et,_.width,_.height,_.depth,0,B,z,_.data);else if(m.isData3DTexture)st?(ht&&e.texStorage3D(t.TEXTURE_3D,Xt,et,_.width,_.height,_.depth),W&&e.texSubImage3D(t.TEXTURE_3D,0,0,0,0,_.width,_.height,_.depth,B,z,_.data)):e.texImage3D(t.TEXTURE_3D,0,et,_.width,_.height,_.depth,0,B,z,_.data);else if(m.isFramebufferTexture){if(ht)if(st)e.texStorage2D(t.TEXTURE_2D,Xt,et,_.width,_.height);else{let G=_.width,Q=_.height;for(let Dt=0;Dt<Xt;Dt++)e.texImage2D(t.TEXTURE_2D,Dt,et,G,Q,0,B,z,null),G>>=1,Q>>=1}}else if(m.isHTMLTexture){if("texElementImage2D"in t){let G=t.canvas;if(G.hasAttribute("layoutsubtree")||G.setAttribute("layoutsubtree","true"),_.parentNode!==G)return G.appendChild(_),S.add(m),G.onpaint=Q=>{let Dt=Q.changedElements;for(let Vt of S)Dt.includes(Vt.image)&&(Vt.needsUpdate=!0)},void G.requestPaint();if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,_);else{let Q=t.RGBA,Dt=t.RGBA,Vt=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,Q,Dt,Vt,_)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(wt.length>0){if(st&&ht){let G=$t(wt[0]);e.texStorage2D(t.TEXTURE_2D,Xt,et,G.width,G.height)}for(let G=0,Q=wt.length;G<Q;G++)q=wt[G],st?W&&e.texSubImage2D(t.TEXTURE_2D,G,0,0,B,z,q):e.texImage2D(t.TEXTURE_2D,G,et,B,z,q);m.generateMipmaps=!1}else if(st){if(ht){let G=$t(_);e.texStorage2D(t.TEXTURE_2D,Xt,et,G.width,G.height)}W&&e.texSubImage2D(t.TEXTURE_2D,0,0,0,B,z,_)}else e.texImage2D(t.TEXTURE_2D,0,et,B,z,_);v(m)&&x(V),A.__version=R.version,m.onUpdate&&m.onUpdate(m)}T.__version=m.version}function yt(T,m,y,V,h,R){let A=r.convert(y.format,y.colorSpace),_=r.convert(y.type),B=F(y.internalFormat,A,_,y.normalized,y.colorSpace),z=i.get(m),et=i.get(y);if(et.__renderTarget=m,!z.__hasExternalTextures){let q=Math.max(1,m.width>>R),wt=Math.max(1,m.height>>R);h===t.TEXTURE_3D||h===t.TEXTURE_2D_ARRAY?e.texImage3D(h,R,B,q,wt,m.depth,0,A,_,null):e.texImage2D(h,R,B,q,wt,0,A,_,null)}e.bindFramebuffer(t.FRAMEBUFFER,T),Nt(m)?u.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,V,h,et.__webglTexture,0,mt(m)):(h===t.TEXTURE_2D||h>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&h<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,V,h,et.__webglTexture,R),e.bindFramebuffer(t.FRAMEBUFFER,null)}function qt(T,m,y){if(t.bindRenderbuffer(t.RENDERBUFFER,T),m.depthBuffer){let V=m.depthTexture,h=V&&V.isDepthTexture?V.type:null,R=U(m.stencilBuffer,h),A=m.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Nt(m)?u.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,mt(m),R,m.width,m.height):y?t.renderbufferStorageMultisample(t.RENDERBUFFER,mt(m),R,m.width,m.height):t.renderbufferStorage(t.RENDERBUFFER,R,m.width,m.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,A,t.RENDERBUFFER,T)}else{let V=m.textures;for(let h=0;h<V.length;h++){let R=V[h],A=r.convert(R.format,R.colorSpace),_=r.convert(R.type),B=F(R.internalFormat,A,_,R.normalized,R.colorSpace);Nt(m)?u.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,mt(m),B,m.width,m.height):y?t.renderbufferStorageMultisample(t.RENDERBUFFER,mt(m),B,m.width,m.height):t.renderbufferStorage(t.RENDERBUFFER,B,m.width,m.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ft(T,m,y){let V=m.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(t.FRAMEBUFFER,T),!m.depthTexture||!m.depthTexture.isDepthTexture)throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let h=i.get(m.depthTexture);if(h.__renderTarget=m,(!h.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),V){if(h.__webglInit===void 0&&(h.__webglInit=!0,m.depthTexture.addEventListener("dispose",I)),h.__webglTexture===void 0){h.__webglTexture=t.createTexture(),e.bindTexture(t.TEXTURE_CUBE_MAP,h.__webglTexture),j(t.TEXTURE_CUBE_MAP,m.depthTexture);let z,et=r.convert(m.depthTexture.format),q=r.convert(m.depthTexture.type);m.depthTexture.format===di?z=t.DEPTH_COMPONENT24:m.depthTexture.format===kn&&(z=t.DEPTH24_STENCIL8);for(let wt=0;wt<6;wt++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+wt,0,z,m.width,m.height,0,et,q,null)}}else tt(m.depthTexture,0);let R=h.__webglTexture,A=mt(m),_=V?t.TEXTURE_CUBE_MAP_POSITIVE_X+y:t.TEXTURE_2D,B=m.depthTexture.format===kn?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(m.depthTexture.format===di)Nt(m)?u.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,B,_,R,0,A):t.framebufferTexture2D(t.FRAMEBUFFER,B,_,R,0);else{if(m.depthTexture.format!==kn)throw new Error("THREE.WebGLTextures: Unknown depthTexture format.");Nt(m)?u.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,B,_,R,0,A):t.framebufferTexture2D(t.FRAMEBUFFER,B,_,R,0)}}function Ct(T){let m=i.get(T),y=T.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==T.depthTexture){let V=T.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),V){let h=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,V.removeEventListener("dispose",h)};V.addEventListener("dispose",h),m.__depthDisposeCallback=h}m.__boundDepthTexture=V}if(T.depthTexture&&!m.__autoAllocateDepthBuffer)if(y)for(let V=0;V<6;V++)Ft(m.__webglFramebuffer[V],T,V);else{let V=T.texture.mipmaps;V&&V.length>0?Ft(m.__webglFramebuffer[0],T,0):Ft(m.__webglFramebuffer,T,0)}else if(y){m.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(e.bindFramebuffer(t.FRAMEBUFFER,m.__webglFramebuffer[V]),m.__webglDepthbuffer[V]===void 0)m.__webglDepthbuffer[V]=t.createRenderbuffer(),qt(m.__webglDepthbuffer[V],T,!1);else{let h=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,R=m.__webglDepthbuffer[V];t.bindRenderbuffer(t.RENDERBUFFER,R),t.framebufferRenderbuffer(t.FRAMEBUFFER,h,t.RENDERBUFFER,R)}}else{let V=T.texture.mipmaps;if(V&&V.length>0?e.bindFramebuffer(t.FRAMEBUFFER,m.__webglFramebuffer[0]):e.bindFramebuffer(t.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=t.createRenderbuffer(),qt(m.__webglDepthbuffer,T,!1);else{let h=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,R=m.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,R),t.framebufferRenderbuffer(t.FRAMEBUFFER,h,t.RENDERBUFFER,R)}}e.bindFramebuffer(t.FRAMEBUFFER,null)}let ae=[],ue=[];function mt(T){return Math.min(a.maxSamples,T.samples)}function Nt(T){let m=i.get(T);return T.samples>0&&n.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function Yt(T,m){let y=T.colorSpace,V=T.format,h=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||y!==ec&&y!==Bn&&(ce.getTransfer(y)===Zt?(V!==bn||h!==an)&&ne("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):re("WebGLTextures: Unsupported texture color space:",y)),m}function $t(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(s.width=T.naturalWidth||T.width,s.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(s.width=T.displayWidth,s.height=T.displayHeight):(s.width=T.width,s.height=T.height),s}this.allocateTextureUnit=function(){let T=ot;return T>=a.maxTextures&&ne("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+a.maxTextures),ot+=1,T},this.resetTextureUnits=function(){ot=0},this.getTextureUnits=function(){return ot},this.setTextureUnits=function(T){ot=T},this.setTexture2D=tt,this.setTexture2DArray=function(T,m){let y=i.get(T);T.isRenderTargetTexture===!1&&T.version>0&&y.__version!==T.version?dt(y,T,m):(T.isExternalTexture&&(y.__webglTexture=T.sourceTexture?T.sourceTexture:null),e.bindTexture(t.TEXTURE_2D_ARRAY,y.__webglTexture,t.TEXTURE0+m))},this.setTexture3D=function(T,m){let y=i.get(T);T.isRenderTargetTexture===!1&&T.version>0&&y.__version!==T.version?dt(y,T,m):e.bindTexture(t.TEXTURE_3D,y.__webglTexture,t.TEXTURE0+m)},this.setTextureCube=function(T,m){let y=i.get(T);T.isCubeDepthTexture!==!0&&T.version>0&&y.__version!==T.version?(function(V,h,R){if(h.image.length!==6)return;let A=k(V,h),_=h.source;e.bindTexture(t.TEXTURE_CUBE_MAP,V.__webglTexture,t.TEXTURE0+R);let B=i.get(_);if(_.version!==B.__version||A===!0){e.activeTexture(t.TEXTURE0+R);let z=ce.getPrimaries(ce.workingColorSpace),et=h.colorSpace===Bn?null:ce.getPrimaries(h.colorSpace),q=h.colorSpace===Bn||z===et?t.NONE:t.BROWSER_DEFAULT_WEBGL;e.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,h.flipY),e.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,h.premultiplyAlpha),e.pixelStorei(t.UNPACK_ALIGNMENT,h.unpackAlignment),e.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,q);let wt=h.isCompressedTexture||h.image[0].isCompressedTexture,st=h.image[0]&&h.image[0].isDataTexture,ht=[];for(let vt=0;vt<6;vt++)ht[vt]=wt||st?st?h.image[vt].image:h.image[vt]:w(h.image[vt],!0,a.maxCubemapSize),ht[vt]=Yt(h,ht[vt]);let W,Xt=ht[0],G=r.convert(h.format,h.colorSpace),Q=r.convert(h.type),Dt=F(h.internalFormat,G,Q,h.normalized,h.colorSpace),Vt=h.isVideoTexture!==!0,de=B.__version===void 0||A===!0,fe=_.dataReady,we=M(h,Xt);if(j(t.TEXTURE_CUBE_MAP,h),wt){Vt&&de&&e.texStorage2D(t.TEXTURE_CUBE_MAP,we,Dt,Xt.width,Xt.height);for(let vt=0;vt<6;vt++){W=ht[vt].mipmaps;for(let Ht=0;Ht<W.length;Ht++){let At=W[Ht];h.format!==bn?G!==null?Vt?fe&&e.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht,0,0,At.width,At.height,G,At.data):e.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht,Dt,At.width,At.height,0,At.data):ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Vt?fe&&e.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht,0,0,At.width,At.height,G,Q,At.data):e.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht,Dt,At.width,At.height,0,G,Q,At.data)}}}else{if(W=h.mipmaps,Vt&&de){W.length>0&&we++;let vt=$t(ht[0]);e.texStorage2D(t.TEXTURE_CUBE_MAP,we,Dt,vt.width,vt.height)}for(let vt=0;vt<6;vt++)if(st){Vt?fe&&e.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,0,0,ht[vt].width,ht[vt].height,G,Q,ht[vt].data):e.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,Dt,ht[vt].width,ht[vt].height,0,G,Q,ht[vt].data);for(let Ht=0;Ht<W.length;Ht++){let At=W[Ht].image[vt].image;Vt?fe&&e.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht+1,0,0,At.width,At.height,G,Q,At.data):e.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht+1,Dt,At.width,At.height,0,G,Q,At.data)}}else{Vt?fe&&e.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,0,0,G,Q,ht[vt]):e.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,Dt,G,Q,ht[vt]);for(let Ht=0;Ht<W.length;Ht++){let At=W[Ht];Vt?fe&&e.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht+1,0,0,G,Q,At.image[vt]):e.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Ht+1,Dt,G,Q,At.image[vt])}}}v(h)&&x(t.TEXTURE_CUBE_MAP),B.__version=_.version,h.onUpdate&&h.onUpdate(h)}V.__version=h.version})(y,T,m):e.bindTexture(t.TEXTURE_CUBE_MAP,y.__webglTexture,t.TEXTURE0+m)},this.rebindTextures=function(T,m,y){let V=i.get(T);m!==void 0&&yt(V.__webglFramebuffer,T,T.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),y!==void 0&&Ct(T)},this.setupRenderTarget=function(T){let m=T.texture,y=i.get(T),V=i.get(m);T.addEventListener("dispose",K);let h=T.textures,R=T.isWebGLCubeRenderTarget===!0,A=h.length>1;if(A||(V.__webglTexture===void 0&&(V.__webglTexture=t.createTexture()),V.__version=m.version,o.memory.textures++),R){y.__webglFramebuffer=[];for(let _=0;_<6;_++)if(m.mipmaps&&m.mipmaps.length>0){y.__webglFramebuffer[_]=[];for(let B=0;B<m.mipmaps.length;B++)y.__webglFramebuffer[_][B]=t.createFramebuffer()}else y.__webglFramebuffer[_]=t.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){y.__webglFramebuffer=[];for(let _=0;_<m.mipmaps.length;_++)y.__webglFramebuffer[_]=t.createFramebuffer()}else y.__webglFramebuffer=t.createFramebuffer();if(A)for(let _=0,B=h.length;_<B;_++){let z=i.get(h[_]);z.__webglTexture===void 0&&(z.__webglTexture=t.createTexture(),o.memory.textures++)}if(T.samples>0&&Nt(T)===!1){y.__webglMultisampledFramebuffer=t.createFramebuffer(),y.__webglColorRenderbuffer=[],e.bindFramebuffer(t.FRAMEBUFFER,y.__webglMultisampledFramebuffer);for(let _=0;_<h.length;_++){let B=h[_];y.__webglColorRenderbuffer[_]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,y.__webglColorRenderbuffer[_]);let z=r.convert(B.format,B.colorSpace),et=r.convert(B.type),q=F(B.internalFormat,z,et,B.normalized,B.colorSpace,T.isXRRenderTarget===!0),wt=mt(T);t.renderbufferStorageMultisample(t.RENDERBUFFER,wt,q,T.width,T.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_,t.RENDERBUFFER,y.__webglColorRenderbuffer[_])}t.bindRenderbuffer(t.RENDERBUFFER,null),T.depthBuffer&&(y.__webglDepthRenderbuffer=t.createRenderbuffer(),qt(y.__webglDepthRenderbuffer,T,!0)),e.bindFramebuffer(t.FRAMEBUFFER,null)}}if(R){e.bindTexture(t.TEXTURE_CUBE_MAP,V.__webglTexture),j(t.TEXTURE_CUBE_MAP,m);for(let _=0;_<6;_++)if(m.mipmaps&&m.mipmaps.length>0)for(let B=0;B<m.mipmaps.length;B++)yt(y.__webglFramebuffer[_][B],T,m,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+_,B);else yt(y.__webglFramebuffer[_],T,m,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+_,0);v(m)&&x(t.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(A){for(let _=0,B=h.length;_<B;_++){let z=h[_],et=i.get(z),q=t.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(q=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),e.bindTexture(q,et.__webglTexture),j(q,z),yt(y.__webglFramebuffer,T,z,t.COLOR_ATTACHMENT0+_,q,0),v(z)&&x(q)}e.unbindTexture()}else{let _=t.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(_=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),e.bindTexture(_,V.__webglTexture),j(_,m),m.mipmaps&&m.mipmaps.length>0)for(let B=0;B<m.mipmaps.length;B++)yt(y.__webglFramebuffer[B],T,m,t.COLOR_ATTACHMENT0,_,B);else yt(y.__webglFramebuffer,T,m,t.COLOR_ATTACHMENT0,_,0);v(m)&&x(_),e.unbindTexture()}T.depthBuffer&&Ct(T)},this.updateRenderTargetMipmap=function(T){let m=T.textures;for(let y=0,V=m.length;y<V;y++){let h=m[y];if(v(h)){let R=N(T),A=i.get(h).__webglTexture;e.bindTexture(R,A),x(R),e.unbindTexture()}}},this.updateMultisampleRenderTarget=function(T){if(T.samples>0){if(Nt(T)===!1){let m=T.textures,y=T.width,V=T.height,h=t.COLOR_BUFFER_BIT,R=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,A=i.get(T),_=m.length>1;if(_)for(let z=0;z<m.length;z++)e.bindFramebuffer(t.FRAMEBUFFER,A.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+z,t.RENDERBUFFER,null),e.bindFramebuffer(t.FRAMEBUFFER,A.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+z,t.TEXTURE_2D,null,0);e.bindFramebuffer(t.READ_FRAMEBUFFER,A.__webglMultisampledFramebuffer);let B=T.texture.mipmaps;B&&B.length>0?e.bindFramebuffer(t.DRAW_FRAMEBUFFER,A.__webglFramebuffer[0]):e.bindFramebuffer(t.DRAW_FRAMEBUFFER,A.__webglFramebuffer);for(let z=0;z<m.length;z++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(h|=t.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(h|=t.STENCIL_BUFFER_BIT)),_){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,A.__webglColorRenderbuffer[z]);let et=i.get(m[z]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,et,0)}t.blitFramebuffer(0,0,y,V,0,0,y,V,h,t.NEAREST),c===!0&&(ae.length=0,ue.length=0,ae.push(t.COLOR_ATTACHMENT0+z),T.depthBuffer&&T.resolveDepthBuffer===!1&&(ae.push(R),ue.push(R),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,ue)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,ae))}if(e.bindFramebuffer(t.READ_FRAMEBUFFER,null),e.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),_)for(let z=0;z<m.length;z++){e.bindFramebuffer(t.FRAMEBUFFER,A.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+z,t.RENDERBUFFER,A.__webglColorRenderbuffer[z]);let et=i.get(m[z]).__webglTexture;e.bindFramebuffer(t.FRAMEBUFFER,A.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+z,t.TEXTURE_2D,et,0)}e.bindFramebuffer(t.DRAW_FRAMEBUFFER,A.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){let m=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[m])}}},this.setupDepthRenderbuffer=Ct,this.setupFrameBufferTexture=yt,this.useMultisampledRTT=Nt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function bd(t,n){return{convert:function(e,i=Bn){let a,r=ce.getTransfer(i);if(e===an)return t.UNSIGNED_BYTE;if(e===Lo)return t.UNSIGNED_SHORT_4_4_4_4;if(e===Uo)return t.UNSIGNED_SHORT_5_5_5_1;if(e===rl)return t.UNSIGNED_INT_5_9_9_9_REV;if(e===ol)return t.UNSIGNED_INT_10F_11F_11F_REV;if(e===sl)return t.BYTE;if(e===ll)return t.SHORT;if(e===Li)return t.UNSIGNED_SHORT;if(e===No)return t.INT;if(e===Dn)return t.UNSIGNED_INT;if(e===ze)return t.FLOAT;if(e===Ye)return t.HALF_FLOAT;if(e===cl)return t.ALPHA;if(e===ul)return t.RGB;if(e===bn)return t.RGBA;if(e===di)return t.DEPTH_COMPONENT;if(e===kn)return t.DEPTH_STENCIL;if(e===dl)return t.RED;if(e===Io)return t.RED_INTEGER;if(e===$n)return t.RG;if(e===Oo)return t.RG_INTEGER;if(e===Fo)return t.RGBA_INTEGER;if(e===Zi||e===Ji||e===Qi||e===ta)if(r===Zt){if(a=n.get("WEBGL_compressed_texture_s3tc_srgb"),a===null)return null;if(e===Zi)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(e===Ji)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(e===Qi)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(e===ta)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else{if(a=n.get("WEBGL_compressed_texture_s3tc"),a===null)return null;if(e===Zi)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(e===Ji)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(e===Qi)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(e===ta)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}if(e===er||e===nr||e===ir||e===ar){if(a=n.get("WEBGL_compressed_texture_pvrtc"),a===null)return null;if(e===er)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(e===nr)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(e===ir)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(e===ar)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}if(e===rr||e===or||e===sr||e===lr||e===cr||e===ua||e===ur){if(a=n.get("WEBGL_compressed_texture_etc"),a===null)return null;if(e===rr||e===or)return r===Zt?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(e===sr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(e===lr)return a.COMPRESSED_R11_EAC;if(e===cr)return a.COMPRESSED_SIGNED_R11_EAC;if(e===ua)return a.COMPRESSED_RG11_EAC;if(e===ur)return a.COMPRESSED_SIGNED_RG11_EAC}if(e===dr||e===fr||e===pr||e===hr||e===mr||e===vr||e===gr||e===_r||e===xr||e===Sr||e===Tr||e===br||e===wr||e===Er){if(a=n.get("WEBGL_compressed_texture_astc"),a===null)return null;if(e===dr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(e===fr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(e===pr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(e===hr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(e===mr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(e===vr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(e===gr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(e===_r)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(e===xr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(e===Sr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(e===Tr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(e===br)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(e===wr)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(e===Er)return r===Zt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}if(e===Mr||e===yr||e===Cr){if(a=n.get("EXT_texture_compression_bptc"),a===null)return null;if(e===Mr)return r===Zt?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(e===yr)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(e===Cr)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}if(e===Rr||e===Ar||e===da||e===Pr){if(a=n.get("EXT_texture_compression_rgtc"),a===null)return null;if(e===Rr)return a.COMPRESSED_RED_RGTC1_EXT;if(e===Ar)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(e===da)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(e===Pr)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}return e===ui?t.UNSIGNED_INT_24_8:t[e]!==void 0?t[e]:null}}}var wd=new En,ls=new Pt;function Ed(t,n){function e(a,r){a.matrixAutoUpdate===!0&&a.updateMatrix(),r.value.copy(a.matrix)}function i(a,r){a.opacity.value=r.opacity,r.color&&a.diffuse.value.copy(r.color),r.emissive&&a.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(a.map.value=r.map,e(r.map,a.mapTransform)),r.alphaMap&&(a.alphaMap.value=r.alphaMap,e(r.alphaMap,a.alphaMapTransform)),r.bumpMap&&(a.bumpMap.value=r.bumpMap,e(r.bumpMap,a.bumpMapTransform),a.bumpScale.value=r.bumpScale,r.side===We&&(a.bumpScale.value*=-1)),r.normalMap&&(a.normalMap.value=r.normalMap,e(r.normalMap,a.normalMapTransform),a.normalScale.value.copy(r.normalScale),r.side===We&&a.normalScale.value.negate()),r.displacementMap&&(a.displacementMap.value=r.displacementMap,e(r.displacementMap,a.displacementMapTransform),a.displacementScale.value=r.displacementScale,a.displacementBias.value=r.displacementBias),r.emissiveMap&&(a.emissiveMap.value=r.emissiveMap,e(r.emissiveMap,a.emissiveMapTransform)),r.specularMap&&(a.specularMap.value=r.specularMap,e(r.specularMap,a.specularMapTransform)),r.alphaTest>0&&(a.alphaTest.value=r.alphaTest);let o=n.get(r),l=o.envMap,u=o.envMapRotation;l&&(a.envMap.value=l,a.envMapRotation.value.setFromMatrix4(wd.makeRotationFromEuler(u)).transpose(),l.isCubeTexture&&l.isRenderTargetTexture===!1&&a.envMapRotation.value.premultiply(ls),a.reflectivity.value=r.reflectivity,a.ior.value=r.ior,a.refractionRatio.value=r.refractionRatio),r.lightMap&&(a.lightMap.value=r.lightMap,a.lightMapIntensity.value=r.lightMapIntensity,e(r.lightMap,a.lightMapTransform)),r.aoMap&&(a.aoMap.value=r.aoMap,a.aoMapIntensity.value=r.aoMapIntensity,e(r.aoMap,a.aoMapTransform))}return{refreshFogUniforms:function(a,r){r.color.getRGB(a.fogColor.value,Bo(t)),r.isFog?(a.fogNear.value=r.near,a.fogFar.value=r.far):r.isFogExp2&&(a.fogDensity.value=r.density)},refreshMaterialUniforms:function(a,r,o,l,u){r.isNodeMaterial?r.uniformsNeedUpdate=!1:r.isMeshBasicMaterial?i(a,r):r.isMeshLambertMaterial?(i(a,r),r.envMap&&(a.envMapIntensity.value=r.envMapIntensity)):r.isMeshToonMaterial?(i(a,r),(function(c,s){s.gradientMap&&(c.gradientMap.value=s.gradientMap)})(a,r)):r.isMeshPhongMaterial?(i(a,r),(function(c,s){c.specular.value.copy(s.specular),c.shininess.value=Math.max(s.shininess,1e-4)})(a,r),r.envMap&&(a.envMapIntensity.value=r.envMapIntensity)):r.isMeshStandardMaterial?(i(a,r),(function(c,s){c.metalness.value=s.metalness,s.metalnessMap&&(c.metalnessMap.value=s.metalnessMap,e(s.metalnessMap,c.metalnessMapTransform)),c.roughness.value=s.roughness,s.roughnessMap&&(c.roughnessMap.value=s.roughnessMap,e(s.roughnessMap,c.roughnessMapTransform)),s.envMap&&(c.envMapIntensity.value=s.envMapIntensity)})(a,r),r.isMeshPhysicalMaterial&&(function(c,s,p){c.ior.value=s.ior,s.sheen>0&&(c.sheenColor.value.copy(s.sheenColor).multiplyScalar(s.sheen),c.sheenRoughness.value=s.sheenRoughness,s.sheenColorMap&&(c.sheenColorMap.value=s.sheenColorMap,e(s.sheenColorMap,c.sheenColorMapTransform)),s.sheenRoughnessMap&&(c.sheenRoughnessMap.value=s.sheenRoughnessMap,e(s.sheenRoughnessMap,c.sheenRoughnessMapTransform))),s.clearcoat>0&&(c.clearcoat.value=s.clearcoat,c.clearcoatRoughness.value=s.clearcoatRoughness,s.clearcoatMap&&(c.clearcoatMap.value=s.clearcoatMap,e(s.clearcoatMap,c.clearcoatMapTransform)),s.clearcoatRoughnessMap&&(c.clearcoatRoughnessMap.value=s.clearcoatRoughnessMap,e(s.clearcoatRoughnessMap,c.clearcoatRoughnessMapTransform)),s.clearcoatNormalMap&&(c.clearcoatNormalMap.value=s.clearcoatNormalMap,e(s.clearcoatNormalMap,c.clearcoatNormalMapTransform),c.clearcoatNormalScale.value.copy(s.clearcoatNormalScale),s.side===We&&c.clearcoatNormalScale.value.negate())),s.dispersion>0&&(c.dispersion.value=s.dispersion),s.iridescence>0&&(c.iridescence.value=s.iridescence,c.iridescenceIOR.value=s.iridescenceIOR,c.iridescenceThicknessMinimum.value=s.iridescenceThicknessRange[0],c.iridescenceThicknessMaximum.value=s.iridescenceThicknessRange[1],s.iridescenceMap&&(c.iridescenceMap.value=s.iridescenceMap,e(s.iridescenceMap,c.iridescenceMapTransform)),s.iridescenceThicknessMap&&(c.iridescenceThicknessMap.value=s.iridescenceThicknessMap,e(s.iridescenceThicknessMap,c.iridescenceThicknessMapTransform))),s.transmission>0&&(c.transmission.value=s.transmission,c.transmissionSamplerMap.value=p.texture,c.transmissionSamplerSize.value.set(p.width,p.height),s.transmissionMap&&(c.transmissionMap.value=s.transmissionMap,e(s.transmissionMap,c.transmissionMapTransform)),c.thickness.value=s.thickness,s.thicknessMap&&(c.thicknessMap.value=s.thicknessMap,e(s.thicknessMap,c.thicknessMapTransform)),c.attenuationDistance.value=s.attenuationDistance,c.attenuationColor.value.copy(s.attenuationColor)),s.anisotropy>0&&(c.anisotropyVector.value.set(s.anisotropy*Math.cos(s.anisotropyRotation),s.anisotropy*Math.sin(s.anisotropyRotation)),s.anisotropyMap&&(c.anisotropyMap.value=s.anisotropyMap,e(s.anisotropyMap,c.anisotropyMapTransform))),c.specularIntensity.value=s.specularIntensity,c.specularColor.value.copy(s.specularColor),s.specularColorMap&&(c.specularColorMap.value=s.specularColorMap,e(s.specularColorMap,c.specularColorMapTransform)),s.specularIntensityMap&&(c.specularIntensityMap.value=s.specularIntensityMap,e(s.specularIntensityMap,c.specularIntensityMapTransform))})(a,r,u)):r.isMeshMatcapMaterial?(i(a,r),(function(c,s){s.matcap&&(c.matcap.value=s.matcap)})(a,r)):r.isMeshDepthMaterial?i(a,r):r.isMeshDistanceMaterial?(i(a,r),(function(c,s){let p=n.get(s).light;c.referencePosition.value.setFromMatrixPosition(p.matrixWorld),c.nearDistance.value=p.shadow.camera.near,c.farDistance.value=p.shadow.camera.far})(a,r)):r.isMeshNormalMaterial?i(a,r):r.isLineBasicMaterial?((function(c,s){c.diffuse.value.copy(s.color),c.opacity.value=s.opacity,s.map&&(c.map.value=s.map,e(s.map,c.mapTransform))})(a,r),r.isLineDashedMaterial&&(function(c,s){c.dashSize.value=s.dashSize,c.totalSize.value=s.dashSize+s.gapSize,c.scale.value=s.scale})(a,r)):r.isPointsMaterial?(function(c,s,p,S){c.diffuse.value.copy(s.color),c.opacity.value=s.opacity,c.size.value=s.size*p,c.scale.value=.5*S,s.map&&(c.map.value=s.map,e(s.map,c.uvTransform)),s.alphaMap&&(c.alphaMap.value=s.alphaMap,e(s.alphaMap,c.alphaMapTransform)),s.alphaTest>0&&(c.alphaTest.value=s.alphaTest)})(a,r,o,l):r.isSpriteMaterial?(function(c,s){c.diffuse.value.copy(s.color),c.opacity.value=s.opacity,c.rotation.value=s.rotation,s.map&&(c.map.value=s.map,e(s.map,c.mapTransform)),s.alphaMap&&(c.alphaMap.value=s.alphaMap,e(s.alphaMap,c.alphaMapTransform)),s.alphaTest>0&&(c.alphaTest.value=s.alphaTest)})(a,r):r.isShadowMaterial?(a.color.value.copy(r.color),a.opacity.value=r.opacity):r.isShaderMaterial&&(r.uniformsNeedUpdate=!1)}}}ls.set(-1,0,0,0,1,0,0,0,1);var Md=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),un=null,yd=class{constructor(t={}){let n,{canvas:e=Zs(),context:i=null,depth:a=!0,stencil:r=!1,alpha:o=!1,antialias:l=!1,premultipliedAlpha:u=!0,preserveDrawingBuffer:c=!1,powerPreference:s="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:S=!1,outputBufferType:g=an}=t;if(this.isWebGLRenderer=!0,i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");n=i.getContextAttributes().alpha}else n=o;let b=g,f=new Set([Fo,Oo,Io]),w=new Set([an,Dn,Li,ui,Lo,Uo]),v=new Uint32Array(4),x=new Int32Array(4),N=new Mt,F=null,U=null,M=[],I=[],K=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=mn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let P=this,ot=!1,tt=null,it=null,at=null,X=null;this._outputColorSpace=tn;let j=0,k=0,D=null,dt=-1,yt=null,qt=new ie,Ft=new ie,Ct=null,ae=new oe(0),ue=0,mt=e.width,Nt=e.height,Yt=1,$t=null,T=null,m=new ie(0,0,mt,Nt),y=new ie(0,0,mt,Nt),V=!1,h=new Ao,R=!1,A=!1,_=new En,B=new Mt,z=new ie,et={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},q=!1;function wt(){return D===null?Yt:1}let st,ht,W,Xt,G,Q,Dt,Vt,de,fe,we,vt,Ht,At,Qt,te,me,He,Ve,gn,$e,ln,_i,E=i;function Ia(d,C){return e.getContext(d,C)}try{let d={alpha:!0,depth:a,stencil:r,antialias:l,premultipliedAlpha:u,preserveDrawingBuffer:c,powerPreference:s,failIfMajorPerformanceCaveat:p};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Js}`),e.addEventListener("webglcontextlost",Fa,!1),e.addEventListener("webglcontextrestored",za,!1),e.addEventListener("webglcontextcreationerror",Ba,!1),E===null){let C="webgl2";if(E=Ia(C,d),E===null)throw Ia(C)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(d){throw re("WebGLRenderer: "+d.message),d}function Oa(){st=new qc(E),st.init(),$e=new bd(E,st),ht=new $c(E,st,t,$e),W=new Sd(E,st),ht.reversedDepthBuffer&&S&&W.buffers.depth.setReversed(!0),it=E.createFramebuffer(),at=E.createFramebuffer(),X=E.createFramebuffer(),Xt=new Zc(E),G=new cd,Q=new Td(E,st,W,G,ht,$e,Xt),Dt=new jc(P),Vt=new Vc(E),ln=new kc(E,Vt),de=new Yc(E,Vt,Xt,ln),fe=new Qc(E,de,Vt,ln,Xt),He=new Jc(E,ht,Q),Qt=new Xc(G),we=new ld(P,Dt,st,ht,ln,Qt),vt=new Ed(P,G),Ht=new dd,At=new vd(st),me=new Gc(P,Dt,W,fe,n,u),te=new xd(P,fe,ht),_i={update(){throw new Error("UniformsGroups are not supported by the Spline runtime")},bind(){throw new Error("UniformsGroups are not supported by the Spline runtime")},dispose(){}},Ve=new Wc(E,st,Xt),gn=new Kc(E,st,Xt),Xt.programs=we.programs,P.capabilities=ht,P.extensions=st,P.properties=G,P.renderLists=Ht,P.shadowMap=te,P.state=W,P.info=Xt}Oa(),b!==an&&(K=new eu(b,e.width,e.height,l,a,r));let ve=Object.assign(new Ro,{enabled:!1,isPresenting:!1,cameraAutoUpdate:!0,setFramebufferScaleFactor(){},setReferenceSpaceType(){},getReferenceSpace:()=>null,setReferenceSpace(){},getBaseLayer:()=>null,getBinding:()=>null,getFrame:()=>null,getSession:()=>null,async setSession(){throw new Error("WebXR is not supported by the Spline runtime")},getEnvironmentBlendMode(){},getDepthTexture:()=>null,updateCamera(){},getCamera:()=>null,getFoveation(){},setFoveation(){},hasDepthSensing:()=>!1,getDepthSensingMesh:()=>null,setAnimationLoop(){},getController:()=>null,getControllerGrip:()=>null,getHand:()=>null,dispose(){}});function Fa(d){d.preventDefault(),Qa("WebGLRenderer: Context Lost."),ot=!0}function za(){Qa("WebGLRenderer: Context Restored."),ot=!1;let d=Xt.autoReset,C=te.enabled,L=te.autoUpdate,H=te.needsUpdate,O=te.type;Oa(),Xt.autoReset=d,te.enabled=C,te.autoUpdate=L,te.needsUpdate=H,te.type=O}function Ba(d){re("WebGLRenderer: A WebGL context could not be created. Reason: ",d.statusMessage)}function Va(d){let C=d.target;C.removeEventListener("dispose",Va),(function(L){(function(H){let O=G.get(H).programs;O!==void 0&&(O.forEach(function(J){we.releaseProgram(J)}),H.isShaderMaterial&&we.releaseShaderCache(H))})(L),G.remove(L)})(C)}function Ha(d,C,L){d.transparent===!0&&d.side===rn&&d.forceSinglePass===!1?(d.side=We,d.needsUpdate=!0,Si(d,C,L),d.side=ci,d.needsUpdate=!0,Si(d,C,L),d.side=rn):Si(d,C,L)}this.xr=ve,this.getContext=function(){return E},this.getContextAttributes=function(){return E.getContextAttributes()},this.forceContextLoss=function(){let d=st.get("WEBGL_lose_context");d&&d.loseContext()},this.forceContextRestore=function(){let d=st.get("WEBGL_lose_context");d&&d.restoreContext()},this.getPixelRatio=function(){return Yt},this.setPixelRatio=function(d){d!==void 0&&(Yt=d,this.setSize(mt,Nt,!1))},this.getSize=function(d){return d.set(mt,Nt)},this.setSize=function(d,C,L=!0){ve.isPresenting?ne("WebGLRenderer: Can't change size while VR device is presenting."):(mt=d,Nt=C,e.width=Math.floor(d*Yt),e.height=Math.floor(C*Yt),L===!0&&(e.style.width=d+"px",e.style.height=C+"px"),K!==null&&K.setSize(e.width,e.height),this.setViewport(0,0,d,C))},this.getDrawingBufferSize=function(d){return d.set(mt*Yt,Nt*Yt).floor()},this.setDrawingBufferSize=function(d,C,L){mt=d,Nt=C,Yt=L,e.width=Math.floor(d*L),e.height=Math.floor(C*L),this.setViewport(0,0,d,C)},this.setEffects=function(d){if(b!==an){if(d){for(let C=0;C<d.length;C++)if(d[C].isOutputPass===!0){ne("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}K.setEffects(d||[])}else re("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.")},this.getCurrentViewport=function(d){return d.copy(qt)},this.getViewport=function(d){return d.copy(m)},this.setViewport=function(d,C,L,H){d.isVector4?m.set(d.x,d.y,d.z,d.w):m.set(d,C,L,H),W.viewport(qt.copy(m).multiplyScalar(Yt).round())},this.getScissor=function(d){return d.copy(y)},this.setScissor=function(d,C,L,H){d.isVector4?y.set(d.x,d.y,d.z,d.w):y.set(d,C,L,H),W.scissor(Ft.copy(y).multiplyScalar(Yt).round())},this.getScissorTest=function(){return V},this.setScissorTest=function(d){W.setScissorTest(V=d)},this.setOpaqueSort=function(d){$t=d},this.setTransparentSort=function(d){T=d},this.getClearColor=function(d){return d.copy(me.getClearColor())},this.setClearColor=function(){me.setClearColor(...arguments)},this.getClearAlpha=function(){return me.getClearAlpha()},this.setClearAlpha=function(){me.setClearAlpha(...arguments)},this.clear=function(d=!0,C=!0,L=!0){let H=0;if(d){let O=!1;if(D!==null){let J=D.texture.format;O=f.has(J)}if(O){let J=D.texture.type,nt=w.has(J),ct=me.getClearColor(),ut=me.getClearAlpha(),xt=ct.r,Lt=ct.g,Ut=ct.b;nt?(v[0]=xt,v[1]=Lt,v[2]=Ut,v[3]=ut,E.clearBufferuiv(E.COLOR,0,v)):(x[0]=xt,x[1]=Lt,x[2]=Ut,x[3]=ut,E.clearBufferiv(E.COLOR,0,x))}else H|=E.COLOR_BUFFER_BIT}C&&(H|=E.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),L&&(H|=E.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&E.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(d){d.setRenderer(this),tt=d},this.dispose=function(){e.removeEventListener("webglcontextlost",Fa,!1),e.removeEventListener("webglcontextrestored",za,!1),e.removeEventListener("webglcontextcreationerror",Ba,!1),me.dispose(),Ht.dispose(),At.dispose(),G.dispose(),Dt.dispose(),fe.dispose(),ln.dispose(),_i.dispose(),we.dispose(),ve.dispose(),ve.removeEventListener("sessionstart",Ga),ve.removeEventListener("sessionend",ka),Mn.stop()},this.renderBufferDirect=function(d,C,L,H,O,J){C===null&&(C=et);let nt=O.isMesh&&O.matrixWorld.determinantAffine()<0,ct=(function(Rt,Ee,ye,St,Tt){Ee.isScene!==!0&&(Ee=et),Q.resetTextureUnits();let Xe=Ee.fog,Wi=St.isMeshStandardMaterial||St.isMeshLambertMaterial||St.isMeshPhongMaterial?Ee.environment:null,Ti=D===null?P.outputColorSpace:D.isXRRenderTarget===!0?D.texture.colorSpace:ce.workingColorSpace,Qn=St.isMeshStandardMaterial||St.isMeshLambertMaterial&&!St.envMap||St.isMeshPhongMaterial&&!St.envMap,Ze=Dt.get(St.envMap||Wi,Qn),Nn=St.vertexColors===!0&&!!ye.attributes.color&&ye.attributes.color.itemSize===4,cn=!!ye.attributes.tangent&&(!!St.normalMap||St.anisotropy>0),$i=!!ye.morphAttributes.position,In=!!ye.morphAttributes.normal,ks=!!ye.morphAttributes.color,Ya=mn;St.toneMapped&&(D===null||D.isXRRenderTarget===!0)&&(Ya=P.toneMapping);let Ka=ye.morphAttributes.position||ye.morphAttributes.normal||ye.morphAttributes.color,Ws=Ka!==void 0?Ka.length:0,Et=G.get(St),yn=U.state.lights;if(R===!0&&(A===!0||Rt!==yt)){let zt=Rt===yt&&St.id===dt;Qt.setState(St,Rt,zt)}let Xi=!1;St.version===Et.__version?(Et.needsLights&&Et.lightsStateVersion!==yn.state.version||Et.outputColorSpace!==Ti||Tt.isBatchedMesh&&Et.batching===!1||!Tt.isBatchedMesh&&Et.batching===!0||Tt.isBatchedMesh&&Et.batchingColor===!0&&Tt.colorTexture===null||Tt.isBatchedMesh&&Et.batchingColor===!1&&Tt.colorTexture!==null||Tt.isInstancedMesh&&Et.instancing===!1||!Tt.isInstancedMesh&&Et.instancing===!0||Tt.isSkinnedMesh&&Et.skinning===!1||!Tt.isSkinnedMesh&&Et.skinning===!0||Tt.isInstancedMesh&&Et.instancingColor===!0&&Tt.instanceColor===null||Tt.isInstancedMesh&&Et.instancingColor===!1&&Tt.instanceColor!==null||Tt.isInstancedMesh&&Et.instancingMorph===!0&&Tt.morphTexture===null||Tt.isInstancedMesh&&Et.instancingMorph===!1&&Tt.morphTexture!==null||Et.envMap!==Ze||St.fog===!0&&Et.fog!==Xe||Et.numClippingPlanes!==void 0&&(Et.numClippingPlanes!==Qt.numPlanes||Et.numIntersection!==Qt.numIntersection)||Et.vertexAlphas!==Nn||Et.vertexTangents!==cn||Et.morphTargets!==$i||Et.morphNormals!==In||Et.morphColors!==ks||Et.toneMapping!==Ya||Et.morphTargetsCount!==Ws||!!Et.lightProbeGrid!=U.state.lightProbeGridArray.length>0)&&(Xi=!0):(Xi=!0,Et.__version=St.version);let _n=Et.currentProgram;Xi===!0&&(_n=Si(St,Ee,Tt),tt&&St.isNodeMaterial&&tt.onUpdateProgram(St,_n,Et));let Za=!1,On=!1,ji=!1,ee=_n.getUniforms(),Ge=Et.uniforms;if(W.useProgram(_n.program)&&(Za=!0,On=!0,ji=!0),St.id!==dt&&(dt=St.id,On=!0),Et.needsLights){let zt=(function(pe,Yi){if(pe.length===0)return null;if(pe.length===1)return pe[0].texture!==null?pe[0]:null;N.setFromMatrixPosition(Yi.matrixWorld);for(let Fn=0,$s=pe.length;Fn<$s;Fn++){let Ki=pe[Fn];if(Ki.texture!==null&&Ki.boundingBox.containsPoint(N))return Ki}return null})(U.state.lightProbeGridArray,Tt);Et.lightProbeGrid!==zt&&(Et.lightProbeGrid=zt,On=!0)}if(Za||yt!==Rt){W.buffers.depth.getReversed()&&Rt.reversedDepth!==!0&&(Rt._reversedDepth=!0,Rt.updateProjectionMatrix()),ee.setValue(E,"projectionMatrix",Rt.projectionMatrix),ee.setValue(E,"viewMatrix",Rt.matrixWorldInverse);let zt=ee.map.cameraPosition;zt!==void 0&&zt.setValue(E,B.setFromMatrixPosition(Rt.matrixWorld)),ht.logarithmicDepthBuffer&&ee.setValue(E,"logDepthBufFC",2/(Math.log(Rt.far+1)/Math.LN2)),(St.isMeshPhongMaterial||St.isMeshToonMaterial||St.isMeshLambertMaterial||St.isMeshBasicMaterial||St.isMeshStandardMaterial||St.isShaderMaterial)&&ee.setValue(E,"isOrthographic",Rt.isOrthographicCamera===!0),yt!==Rt&&(yt=Rt,On=!0,ji=!0)}if(Et.needsLights&&(yn.state.directionalShadowMap.length>0&&ee.setValue(E,"directionalShadowMap",yn.state.directionalShadowMap,Q),yn.state.spotShadowMap.length>0&&ee.setValue(E,"spotShadowMap",yn.state.spotShadowMap,Q),yn.state.pointShadowMap.length>0&&ee.setValue(E,"pointShadowMap",yn.state.pointShadowMap,Q)),Tt.isSkinnedMesh){ee.setOptional(E,Tt,"bindMatrix"),ee.setOptional(E,Tt,"bindMatrixInverse");let zt=Tt.skeleton;zt&&(zt.boneTexture===null&&zt.computeBoneTexture(),ee.setValue(E,"boneTexture",zt.boneTexture,Q))}Tt.isBatchedMesh&&(ee.setOptional(E,Tt,"batchingTexture"),ee.setValue(E,"batchingTexture",Tt._matricesTexture,Q),ee.setOptional(E,Tt,"batchingIdTexture"),ee.setValue(E,"batchingIdTexture",Tt._indirectTexture,Q),ee.setOptional(E,Tt,"batchingColorTexture"),Tt._colorsTexture!==null&&ee.setValue(E,"batchingColorTexture",Tt._colorsTexture,Q));let qi=ye.morphAttributes;if((qi.position!==void 0||qi.normal!==void 0||qi.color!==void 0)&&He.update(Tt,ye,_n),(On||Et.receiveShadow!==Tt.receiveShadow)&&(Et.receiveShadow=Tt.receiveShadow,ee.setValue(E,"receiveShadow",Tt.receiveShadow)),(St.isMeshStandardMaterial||St.isMeshLambertMaterial||St.isMeshPhongMaterial)&&St.envMap===null&&Ee.environment!==null&&(Ge.envMapIntensity.value=Ee.environmentIntensity),Ge.dfgLUT!==void 0&&(Ge.dfgLUT.value=(un===null&&((un=new Pi(Md,16,16,$n,Ye)).name="DFG_LUT",un.minFilter=jt,un.magFilter=jt,un.wrapS=Re,un.wrapT=Re,un.generateMipmaps=!1,un.needsUpdate=!0),un)),On){if(ee.setValue(E,"toneMappingExposure",P.toneMappingExposure),Et.needsLights&&(function(zt,pe){zt.ambientLightColor.needsUpdate=pe,zt.lightProbe.needsUpdate=pe,zt.directionalLights.needsUpdate=pe,zt.directionalLightShadows.needsUpdate=pe,zt.pointLights.needsUpdate=pe,zt.pointLightShadows.needsUpdate=pe,zt.spotLights.needsUpdate=pe,zt.spotLightShadows.needsUpdate=pe,zt.rectAreaLights.needsUpdate=pe,zt.hemisphereLights.needsUpdate=pe})(Ge,ji),Xe&&St.fog===!0&&vt.refreshFogUniforms(Ge,Xe),vt.refreshMaterialUniforms(Ge,St,Yt,Nt,U.state.transmissionRenderTarget[Rt.id]),Et.needsLights&&Et.lightProbeGrid){let zt=Et.lightProbeGrid;Ge.probesSH.value=zt.texture,Ge.probesMin.value.copy(zt.boundingBox.min),Ge.probesMax.value.copy(zt.boundingBox.max),Ge.probesResolution.value.copy(zt.resolution)}Ai.upload(E,ja(Et),Ge,Q)}if(St.isShaderMaterial&&St.uniformsNeedUpdate===!0&&(Ai.upload(E,ja(Et),Ge,Q),St.uniformsNeedUpdate=!1),St.isSpriteMaterial&&ee.setValue(E,"center",Tt.center),ee.setValue(E,"modelViewMatrix",Tt.modelViewMatrix),ee.setValue(E,"normalMatrix",Tt.normalMatrix),ee.setValue(E,"modelMatrix",Tt.matrixWorld),Tt.previousModelViewMatrix&&ee.setValue(E,"previousModelViewMatrix",Tt.previousModelViewMatrix),Rt.previousProjectionMatrix&&ee.setValue(E,"previousProjectionMatrix",Rt.previousProjectionMatrix),St.uniformsGroups!==void 0){let zt=St.uniformsGroups;for(let pe=0,Yi=zt.length;pe<Yi;pe++){let Fn=zt[pe];_i.update(Fn,_n),_i.bind(Fn,_n)}}return _n})(d,C,L,H,O);W.setMaterial(H,nt);let ut=L.index,xt=1;if(H.wireframe===!0){if(ut=de.getWireframeAttribute(L),ut===void 0)return;xt=2}let Lt=L.drawRange,Ut=L.attributes.position,gt=Lt.start*xt,It=(Lt.start+Lt.count)*xt;J!==null&&(gt=Math.max(gt,J.start*xt),It=Math.min(It,(J.start+J.count)*xt)),ut!==null?(gt=Math.max(gt,0),It=Math.min(It,ut.count)):Ut!=null&&(gt=Math.max(gt,0),It=Math.min(It,Ut.count));let xe=It-gt;if(xe<0||xe===1/0)return;ln.setup(O,H,ct,L,ut);let ge,Kt=Ve;if(ut!==null&&(ge=Vt.get(ut),Kt=gn,Kt.setIndex(ge)),O.isMesh)H.wireframe===!0?(W.setLineWidth(H.wireframeLinewidth*wt()),Kt.setMode(E.LINES)):Kt.setMode(E.TRIANGLES);else if(O.isLine){let Rt=H.linewidth;Rt===void 0&&(Rt=1),W.setLineWidth(Rt*wt()),O.isLineSegments?Kt.setMode(E.LINES):O.isLineLoop?Kt.setMode(E.LINE_LOOP):Kt.setMode(E.LINE_STRIP)}else O.isPoints?Kt.setMode(E.POINTS):O.isSprite&&Kt.setMode(E.TRIANGLES);if(O.isBatchedMesh)if(st.get("WEBGL_multi_draw"))Kt.renderMultiDraw(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount);else{let Rt=O._multiDrawStarts,Ee=O._multiDrawCounts,ye=O._multiDrawCount,St=ut?Vt.get(ut).bytesPerElement:1,Tt=G.get(H).currentProgram.getUniforms();for(let Xe=0;Xe<ye;Xe++)Tt.setValue(E,"_gl_DrawID",Xe),Kt.render(Rt[Xe]/St,Ee[Xe])}else if(O.isInstancedMesh)Kt.renderInstances(gt,xe,O.count);else if(L.isInstancedBufferGeometry){let Rt=L._maxInstanceCount!==void 0?L._maxInstanceCount:1/0,Ee=Math.min(L.instanceCount,Rt);Kt.renderInstances(gt,xe,Ee)}else Kt.render(gt,xe)},this.compile=function(d,C,L=null){L===null&&(L=d),U=At.get(L),U.init(C),I.push(U),L.traverseVisible(function(O){O.isLight&&O.layers.test(C.layers)&&(U.pushLight(O),O.castShadow&&U.pushShadow(O))}),d!==L&&d.traverseVisible(function(O){O.isLight&&O.layers.test(C.layers)&&(U.pushLight(O),O.castShadow&&U.pushShadow(O))}),U.setupLights();let H=new Set;return d.traverse(function(O){if(!(O.isMesh||O.isPoints||O.isLine||O.isSprite))return;let J=O.material;if(J)if(Array.isArray(J))for(let nt=0;nt<J.length;nt++){let ct=J[nt];Ha(ct,L,O),H.add(ct)}else Ha(J,L,O),H.add(J)}),U=I.pop(),H},this.compileAsync=function(d,C,L=null){let H=this.compile(d,C,L);return new Promise(O=>{function J(){H.forEach(function(nt){G.get(nt).currentProgram.isReady()&&H.delete(nt)}),H.size!==0?setTimeout(J,10):O(d)}st.get("KHR_parallel_shader_compile")!==null?J():setTimeout(J,10)})};let Gi=null;function Ga(){Mn.stop()}function ka(){Mn.start()}let Mn=new Bc;function ki(d,C,L,H){if(d.visible===!1)return;if(d.layers.test(C.layers)){if(d.isGroup)L=d.renderOrder;else if(d.isLOD)d.autoUpdate===!0&&d.update(C);else if(d.isLightProbeGrid)U.pushLightProbeGrid(d);else if(d.isLight)U.pushLight(d),d.castShadow&&U.pushShadow(d);else if(d.isSprite){if(!d.frustumCulled||h.intersectsSprite(d)){H&&z.setFromMatrixPosition(d.matrixWorld).applyMatrix4(_);let J=fe.update(d),nt=d.material;nt.visible&&F.push(d,J,nt,L,z.z,null)}}else if((d.isMesh||d.isLine||d.isPoints)&&(!d.frustumCulled||h.intersectsObject(d))){let J=fe.update(d),nt=d.material;if(H&&(d.boundingSphere!==void 0?(d.boundingSphere===null&&d.computeBoundingSphere(),z.copy(d.boundingSphere.center)):(J.boundingSphere===null&&J.computeBoundingSphere(),z.copy(J.boundingSphere.center)),z.applyMatrix4(d.matrixWorld).applyMatrix4(_)),Array.isArray(nt)){let ct=J.groups;for(let ut=0,xt=ct.length;ut<xt;ut++){let Lt=ct[ut],Ut=nt[Lt.materialIndex];Ut&&Ut.visible&&F.push(d,J,Ut,L,z.z,Lt)}}else nt.visible&&F.push(d,J,nt,L,z.z,null)}}let O=d.children;for(let J=0,nt=O.length;J<nt;J++)ki(O[J],C,L,H)}function Wa(d,C,L,H){let{opaque:O,transmissive:J,transparent:nt}=d;U.setupLightsView(L),R===!0&&Qt.setGlobalState(P.clippingPlanes,L),H&&W.viewport(qt.copy(H)),O.length>0&&xi(O,C,L),J.length>0&&xi(J,C,L),nt.length>0&&xi(nt,C,L),W.buffers.depth.setTest(!0),W.buffers.depth.setMask(!0),W.buffers.color.setMask(!0),W.setPolygonOffset(!1)}function $a(d,C,L,H){if((L.isScene===!0?L.overrideMaterial:null)!==null)return;if(U.state.transmissionRenderTarget[H.id]===void 0){let Ut=st.has("EXT_color_buffer_half_float")||st.has("EXT_color_buffer_float");U.state.transmissionRenderTarget[H.id]=new se(1,1,{generateMipmaps:!0,type:Ut?Ye:an,minFilter:Pn,samples:Math.max(4,ht.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ce.workingColorSpace})}let O=U.state.transmissionRenderTarget[H.id],J=H.viewport||qt;O.setSize(J.z*P.transmissionResolutionScale,J.w*P.transmissionResolutionScale);let nt=P.getRenderTarget(),ct=P.getActiveCubeFace(),ut=P.getActiveMipmapLevel();P.setRenderTarget(O),P.getClearColor(ae),ue=P.getClearAlpha(),ue<1&&P.setClearColor(16777215,.5),P.clear(),q&&me.render(L);let xt=P.toneMapping;P.toneMapping=mn;let Lt=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),U.setupLightsView(H),R===!0&&Qt.setGlobalState(P.clippingPlanes,H),xi(d,L,H),Q.updateMultisampleRenderTarget(O),Q.updateRenderTargetMipmap(O),st.has("WEBGL_multisampled_render_to_texture")===!1){let Ut=!1;for(let gt=0,It=C.length;gt<It;gt++){let xe=C[gt],{object:ge,geometry:Kt,material:Rt,group:Ee}=xe;if(Rt.side===rn&&ge.layers.test(H.layers)){let ye=Rt.side;Rt.side=We,Rt.needsUpdate=!0,Xa(ge,L,H,Kt,Rt,Ee),Rt.side=ye,Rt.needsUpdate=!0,Ut=!0}}Ut===!0&&(Q.updateMultisampleRenderTarget(O),Q.updateRenderTargetMipmap(O))}P.setRenderTarget(nt,ct,ut),P.setClearColor(ae,ue),Lt!==void 0&&(H.viewport=Lt),P.toneMapping=xt}function xi(d,C,L){let H=C.isScene===!0?C.overrideMaterial:null;for(let O=0,J=d.length;O<J;O++){let nt=d[O],{object:ct,geometry:ut,group:xt}=nt,Lt=nt.material;Lt.allowOverride===!0&&H!==null&&(Lt=H),ct.layers.test(L.layers)&&Xa(ct,C,L,ut,Lt,xt)}}function Xa(d,C,L,H,O,J){d.onBeforeRender(P,C,L,H,O,J),d.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,d.matrixWorld),d.normalMatrix.getNormalMatrix(d.modelViewMatrix),O.onBeforeRender(P,C,L,H,d,J),O.transparent===!0&&O.side===rn&&O.forceSinglePass===!1?(O.side=We,O.needsUpdate=!0,P.renderBufferDirect(L,C,H,O,d,J),O.side=ci,O.needsUpdate=!0,P.renderBufferDirect(L,C,H,O,d,J),O.side=rn):P.renderBufferDirect(L,C,H,O,d,J),d.onAfterRender(P,C,L,H,O,J)}function Si(d,C,L){C.isScene!==!0&&(C=et);let H=G.get(d),O=U.state.lights,J=U.state.shadowsArray,nt=O.state.version,ct=we.getParameters(d,O.state,J,C,L,U.state.lightProbeGridArray),ut=we.getProgramCacheKey(ct),xt=H.programs;H.environment=d.isMeshStandardMaterial||d.isMeshLambertMaterial||d.isMeshPhongMaterial?C.environment:null,H.fog=C.fog;let Lt=d.isMeshStandardMaterial||d.isMeshLambertMaterial&&!d.envMap||d.isMeshPhongMaterial&&!d.envMap;H.envMap=Dt.get(d.envMap||H.environment,Lt),H.envMapRotation=H.environment!==null&&d.envMap===null?C.environmentRotation:d.envMapRotation,xt===void 0&&(d.addEventListener("dispose",Va),xt=new Map,H.programs=xt);let Ut=xt.get(ut);if(Ut!==void 0){if(H.currentProgram===Ut&&H.lightsStateVersion===nt)return qa(d,ct),Ut}else ct.uniforms=we.getUniforms(d),tt!==null&&d.isNodeMaterial&&tt.build(d,L,ct),d.onBeforeCompile(ct,P),Ut=we.acquireProgram(ct,ut),xt.set(ut,Ut),H.uniforms=ct.uniforms;let gt=H.uniforms;return(!d.isShaderMaterial&&!d.isRawShaderMaterial||d.clipping===!0)&&(gt.clippingPlanes=Qt.uniform),qa(d,ct),H.needsLights=(function(It){return It.isMeshLambertMaterial||It.isMeshToonMaterial||It.isMeshPhongMaterial||It.isMeshStandardMaterial||It.isShadowMaterial||It.isShaderMaterial&&It.lights===!0})(d),H.lightsStateVersion=nt,H.needsLights&&(gt.ambientLightColor.value=O.state.ambient,gt.lightProbe.value=O.state.probe,gt.directionalLights.value=O.state.directional,gt.directionalLightShadows.value=O.state.directionalShadow,gt.spotLights.value=O.state.spot,gt.spotLightShadows.value=O.state.spotShadow,gt.rectAreaLights.value=O.state.rectArea,gt.ltc_1.value=O.state.rectAreaLTC1,gt.ltc_2.value=O.state.rectAreaLTC2,gt.pointLights.value=O.state.point,gt.pointLightShadows.value=O.state.pointShadow,gt.hemisphereLights.value=O.state.hemi,gt.directionalShadowMatrix.value=O.state.directionalShadowMatrix,gt.spotLightMatrix.value=O.state.spotLightMatrix,gt.spotLightMap.value=O.state.spotLightMap,gt.pointShadowMatrix.value=O.state.pointShadowMatrix),H.lightProbeGrid=U.state.lightProbeGridArray.length>0,H.currentProgram=Ut,H.uniformsList=null,Ut}function ja(d){if(d.uniformsList===null){let C=d.currentProgram.getUniforms();d.uniformsList=Ai.seqWithValue(C.seq,d.uniforms)}return d.uniformsList}function qa(d,C){let L=G.get(d);L.outputColorSpace=C.outputColorSpace,L.batching=C.batching,L.batchingColor=C.batchingColor,L.instancing=C.instancing,L.instancingColor=C.instancingColor,L.instancingMorph=C.instancingMorph,L.skinning=C.skinning,L.morphTargets=C.morphTargets,L.morphNormals=C.morphNormals,L.morphColors=C.morphColors,L.morphTargetsCount=C.morphTargetsCount,L.numClippingPlanes=C.numClippingPlanes,L.numIntersection=C.numClipIntersection,L.vertexAlphas=C.vertexAlphas,L.vertexTangents=C.vertexTangents,L.toneMapping=C.toneMapping}Mn.setAnimationLoop(function(d){Gi&&Gi(d)}),typeof self<"u"&&Mn.setContext(self),this.setAnimationLoop=function(d){Gi=d,ve.setAnimationLoop(d),d===null?Mn.stop():Mn.start()},ve.addEventListener("sessionstart",Ga),ve.addEventListener("sessionend",ka),this.render=function(d,C){if(C!==void 0&&C.isCamera!==!0)return void re("WebGLRenderer.render: camera is not an instance of THREE.Camera.");if(ot===!0)return;tt!==null&&tt.renderStart(d,C);let L=ve.enabled===!0&&ve.isPresenting===!0,H=K!==null&&(D===null||L)&&K.begin(P,D);if(d.matrixWorldAutoUpdate===!0&&d.updateMatrixWorld(),C.parent===null&&C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),ve.enabled===!0&&ve.isPresenting===!0&&(K===null||K.isCompositing()===!1)&&(ve.cameraAutoUpdate===!0&&ve.updateCamera(C),C=ve.getCamera()),d.isScene===!0&&d.onBeforeRender(P,d,C,D),U=At.get(d,I.length),U.init(C),U.state.textureUnits=Q.getTextureUnits(),I.push(U),_.multiplyMatrices(C.projectionMatrix,C.matrixWorldInverse),h.setFromProjectionMatrix(_,tr,C.reversedDepth),A=this.localClippingEnabled,R=Qt.init(this.clippingPlanes,A),F=Ht.get(d,M.length),F.init(),M.push(F),ve.enabled===!0&&ve.isPresenting===!0){let J=P.xr.getDepthSensingMesh();J!==null&&ki(J,C,-1/0,P.sortObjects)}ki(d,C,0,P.sortObjects),F.finish(),P.sortObjects===!0&&F.sort($t,T,C.reversedDepth),q=ve.enabled===!1||ve.isPresenting===!1||ve.hasDepthSensing()===!1,q&&me.addToRenderList(F,d),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),R===!0&&Qt.beginShadows();let O=U.state.shadowsArray;if(te.render(O,d,C),R===!0&&Qt.endShadows(),(H&&K.hasRenderPass())===!1){let J=F.opaque,nt=F.transmissive;if(U.setupLights(),C.isArrayCamera){let ct=C.cameras;if(nt.length>0)for(let ut=0,xt=ct.length;ut<xt;ut++)$a(J,nt,d,ct[ut]);q&&me.render(d);for(let ut=0,xt=ct.length;ut<xt;ut++){let Lt=ct[ut];Wa(F,d,Lt,Lt.viewport)}}else nt.length>0&&$a(J,nt,d,C),q&&me.render(d),Wa(F,d,C)}D!==null&&k===0&&(Q.updateMultisampleRenderTarget(D),Q.updateRenderTargetMipmap(D)),H&&K.end(P),d.isScene===!0&&d.onAfterRender(P,d,C),ln.resetDefaultState(),dt=-1,yt=null,I.pop(),I.length>0?(U=I[I.length-1],Q.setTextureUnits(U.state.textureUnits),R===!0&&Qt.setGlobalState(P.clippingPlanes,U.state.camera)):U=null,M.pop(),F=M.length>0?M[M.length-1]:null,tt!==null&&tt.renderEnd()},this.getActiveCubeFace=function(){return j},this.getActiveMipmapLevel=function(){return k},this.getRenderTarget=function(){return D},this.setRenderTargetTextures=function(d,C,L){let H=G.get(d);H.__autoAllocateDepthBuffer=d.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),G.get(d.texture).__webglTexture=C,G.get(d.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:L,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(d,C){let L=G.get(d);L.__webglFramebuffer=C,L.__useDefaultFramebuffer=C===void 0},this.setRenderTarget=function(d,C=0,L=0){D=d,j=C,k=L;let H=null,O=!1,J=!1;if(d){let nt=G.get(d);if(nt.__useDefaultFramebuffer!==void 0)return W.bindFramebuffer(E.FRAMEBUFFER,nt.__webglFramebuffer),qt.copy(d.viewport),Ft.copy(d.scissor),Ct=d.scissorTest,W.viewport(qt),W.scissor(Ft),W.setScissorTest(Ct),void(dt=-1);if(nt.__webglFramebuffer===void 0)Q.setupRenderTarget(d);else if(nt.__hasExternalTextures)Q.rebindTextures(d,G.get(d.texture).__webglTexture,G.get(d.depthTexture).__webglTexture);else if(d.depthBuffer){let xt=d.depthTexture;if(nt.__boundDepthTexture!==xt){if(xt!==null&&G.has(xt)&&(d.width!==xt.image.width||d.height!==xt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Q.setupDepthRenderbuffer(d)}}let ct=d.texture;(ct.isData3DTexture||ct.isDataArrayTexture||ct.isCompressedArrayTexture)&&(J=!0);let ut=G.get(d).__webglFramebuffer;d.isWebGLCubeRenderTarget?(H=Array.isArray(ut[C])?ut[C][L]:ut[C],O=!0):H=d.samples>0&&Q.useMultisampledRTT(d)===!1?G.get(d).__webglMultisampledFramebuffer:Array.isArray(ut)?ut[L]:ut,qt.copy(d.viewport),Ft.copy(d.scissor),Ct=d.scissorTest}else qt.copy(m).multiplyScalar(Yt).floor(),Ft.copy(y).multiplyScalar(Yt).floor(),Ct=V;if(L!==0&&(H=it),W.bindFramebuffer(E.FRAMEBUFFER,H)&&W.drawBuffers(d,H),W.viewport(qt),W.scissor(Ft),W.setScissorTest(Ct),O){let nt=G.get(d.texture);E.framebufferTexture2D(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_CUBE_MAP_POSITIVE_X+C,nt.__webglTexture,L)}else if(J){let nt=C;for(let ct=0;ct<d.textures.length;ct++){let ut=G.get(d.textures[ct]);E.framebufferTextureLayer(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0+ct,ut.__webglTexture,L,nt)}}else if(d!==null&&L!==0){let nt=G.get(d.texture);E.framebufferTexture2D(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,nt.__webglTexture,L)}dt=-1},this.readRenderTargetPixels=function(d,C,L,H,O,J,nt,ct=0){if(!d||!d.isWebGLRenderTarget)return void re("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ut=G.get(d).__webglFramebuffer;if(d.isWebGLCubeRenderTarget&&nt!==void 0&&(ut=ut[nt]),ut){W.bindFramebuffer(E.FRAMEBUFFER,ut);try{let xt=d.textures[ct],Lt=xt.format,Ut=xt.type;if(d.textures.length>1&&E.readBuffer(E.COLOR_ATTACHMENT0+ct),!ht.textureFormatReadable(Lt))return void re("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");if(!ht.textureTypeReadable(Ut))return void re("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");C>=0&&C<=d.width-H&&L>=0&&L<=d.height-O&&E.readPixels(C,L,H,O,$e.convert(Lt),$e.convert(Ut),J)}finally{let xt=D!==null?G.get(D).__webglFramebuffer:null;W.bindFramebuffer(E.FRAMEBUFFER,xt)}}},this.readRenderTargetPixelsAsync=async function(d,C,L,H,O,J,nt,ct=0){if(!d||!d.isWebGLRenderTarget)throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ut=G.get(d).__webglFramebuffer;if(d.isWebGLCubeRenderTarget&&nt!==void 0&&(ut=ut[nt]),ut){if(C>=0&&C<=d.width-H&&L>=0&&L<=d.height-O){W.bindFramebuffer(E.FRAMEBUFFER,ut);let xt=d.textures[ct],Lt=xt.format,Ut=xt.type;if(d.textures.length>1&&E.readBuffer(E.COLOR_ATTACHMENT0+ct),!ht.textureFormatReadable(Lt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ht.textureTypeReadable(Ut))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let gt=E.createBuffer();E.bindBuffer(E.PIXEL_PACK_BUFFER,gt),E.bufferData(E.PIXEL_PACK_BUFFER,J.byteLength,E.STREAM_READ),E.readPixels(C,L,H,O,$e.convert(Lt),$e.convert(Ut),0);let It=D!==null?G.get(D).__webglFramebuffer:null;W.bindFramebuffer(E.FRAMEBUFFER,It);let xe=E.fenceSync(E.SYNC_GPU_COMMANDS_COMPLETE,0);return E.flush(),await Qs(E,xe,4),E.bindBuffer(E.PIXEL_PACK_BUFFER,gt),E.getBufferSubData(E.PIXEL_PACK_BUFFER,0,J),E.deleteBuffer(gt),E.deleteSync(xe),J}throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(d,C=null,L=0){let H=Math.pow(2,-L),O=Math.floor(d.image.width*H),J=Math.floor(d.image.height*H),nt=C!==null?C.x:0,ct=C!==null?C.y:0;Q.setTexture2D(d,0),E.copyTexSubImage2D(E.TEXTURE_2D,L,0,0,nt,ct,O,J),W.unbindTexture()},this.copyTextureToTexture=function(d,C,L=null,H=null,O=0,J=0){let nt,ct,ut,xt,Lt,Ut,gt,It,xe,ge=d.isCompressedTexture?d.mipmaps[J]:d.image;if(L!==null)nt=L.max.x-L.min.x,ct=L.max.y-L.min.y,ut=L.isBox3?L.max.z-L.min.z:1,xt=L.min.x,Lt=L.min.y,Ut=L.isBox3?L.min.z:0;else{let Ze=Math.pow(2,-O);nt=Math.floor(ge.width*Ze),ct=Math.floor(ge.height*Ze),ut=d.isDataArrayTexture?ge.depth:d.isData3DTexture?Math.floor(ge.depth*Ze):1,xt=0,Lt=0,Ut=0}H!==null?(gt=H.x,It=H.y,xe=H.z):(gt=0,It=0,xe=0);let Kt,Rt=$e.convert(C.format),Ee=$e.convert(C.type);C.isData3DTexture?(Q.setTexture3D(C,0),Kt=E.TEXTURE_3D):C.isDataArrayTexture||C.isCompressedArrayTexture?(Q.setTexture2DArray(C,0),Kt=E.TEXTURE_2D_ARRAY):(Q.setTexture2D(C,0),Kt=E.TEXTURE_2D),W.activeTexture(E.TEXTURE0),W.pixelStorei(E.UNPACK_FLIP_Y_WEBGL,C.flipY),W.pixelStorei(E.UNPACK_PREMULTIPLY_ALPHA_WEBGL,C.premultiplyAlpha),W.pixelStorei(E.UNPACK_ALIGNMENT,C.unpackAlignment);let ye=W.getParameter(E.UNPACK_ROW_LENGTH),St=W.getParameter(E.UNPACK_IMAGE_HEIGHT),Tt=W.getParameter(E.UNPACK_SKIP_PIXELS),Xe=W.getParameter(E.UNPACK_SKIP_ROWS),Wi=W.getParameter(E.UNPACK_SKIP_IMAGES);W.pixelStorei(E.UNPACK_ROW_LENGTH,ge.width),W.pixelStorei(E.UNPACK_IMAGE_HEIGHT,ge.height),W.pixelStorei(E.UNPACK_SKIP_PIXELS,xt),W.pixelStorei(E.UNPACK_SKIP_ROWS,Lt),W.pixelStorei(E.UNPACK_SKIP_IMAGES,Ut);let Ti=d.isDataArrayTexture||d.isData3DTexture,Qn=C.isDataArrayTexture||C.isData3DTexture;if(d.isDepthTexture){let Ze=G.get(d),Nn=G.get(C),cn=G.get(Ze.__renderTarget),$i=G.get(Nn.__renderTarget);W.bindFramebuffer(E.READ_FRAMEBUFFER,cn.__webglFramebuffer),W.bindFramebuffer(E.DRAW_FRAMEBUFFER,$i.__webglFramebuffer);for(let In=0;In<ut;In++)Ti&&(E.framebufferTextureLayer(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,G.get(d).__webglTexture,O,Ut+In),E.framebufferTextureLayer(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,G.get(C).__webglTexture,J,xe+In)),E.blitFramebuffer(xt,Lt,nt,ct,gt,It,nt,ct,E.DEPTH_BUFFER_BIT,E.NEAREST);W.bindFramebuffer(E.READ_FRAMEBUFFER,null),W.bindFramebuffer(E.DRAW_FRAMEBUFFER,null)}else if(O!==0||d.isRenderTargetTexture||G.has(d)){let Ze=G.get(d),Nn=G.get(C);W.bindFramebuffer(E.READ_FRAMEBUFFER,at),W.bindFramebuffer(E.DRAW_FRAMEBUFFER,X);for(let cn=0;cn<ut;cn++)Ti?E.framebufferTextureLayer(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,Ze.__webglTexture,O,Ut+cn):E.framebufferTexture2D(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,Ze.__webglTexture,O),Qn?E.framebufferTextureLayer(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,Nn.__webglTexture,J,xe+cn):E.framebufferTexture2D(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,Nn.__webglTexture,J),O!==0?E.blitFramebuffer(xt,Lt,nt,ct,gt,It,nt,ct,E.COLOR_BUFFER_BIT,E.NEAREST):Qn?E.copyTexSubImage3D(Kt,J,gt,It,xe+cn,xt,Lt,nt,ct):E.copyTexSubImage2D(Kt,J,gt,It,xt,Lt,nt,ct);W.bindFramebuffer(E.READ_FRAMEBUFFER,null),W.bindFramebuffer(E.DRAW_FRAMEBUFFER,null)}else Qn?d.isDataTexture||d.isData3DTexture?E.texSubImage3D(Kt,J,gt,It,xe,nt,ct,ut,Rt,Ee,ge.data):C.isCompressedArrayTexture?E.compressedTexSubImage3D(Kt,J,gt,It,xe,nt,ct,ut,Rt,ge.data):E.texSubImage3D(Kt,J,gt,It,xe,nt,ct,ut,Rt,Ee,ge):d.isDataTexture?E.texSubImage2D(E.TEXTURE_2D,J,gt,It,nt,ct,Rt,Ee,ge.data):d.isCompressedTexture?E.compressedTexSubImage2D(E.TEXTURE_2D,J,gt,It,ge.width,ge.height,Rt,ge.data):E.texSubImage2D(E.TEXTURE_2D,J,gt,It,nt,ct,Rt,Ee,ge);W.pixelStorei(E.UNPACK_ROW_LENGTH,ye),W.pixelStorei(E.UNPACK_IMAGE_HEIGHT,St),W.pixelStorei(E.UNPACK_SKIP_PIXELS,Tt),W.pixelStorei(E.UNPACK_SKIP_ROWS,Xe),W.pixelStorei(E.UNPACK_SKIP_IMAGES,Wi),J===0&&C.generateMipmaps&&E.generateMipmap(Kt),W.unbindTexture()},this.initRenderTarget=function(d){G.get(d).__webglFramebuffer===void 0&&Q.setupRenderTarget(d)},this.initTexture=function(d){d.isCubeTexture?Q.setTextureCube(d,0):d.isData3DTexture?Q.setTexture3D(d,0):d.isDataArrayTexture||d.isCompressedArrayTexture?Q.setTexture2DArray(d,0):Q.setTexture2D(d,0),W.unbindTexture()},this.resetState=function(){j=0,k=0,D=null,W.reset(),ln.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return tr}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=ce._getDrawingBufferColorSpace(t),n.unpackColorSpace=ce._getUnpackColorSpace()}},De=class extends Be{constructor(t){super("b"),this.nodeType="Bool",this.value=t??!1}generateReadonly(t,n,e,i){return t.format(this.value?"true":"false",i,n)}},Rn=class extends Be{constructor(t=1,n){super("f[]"),this.nodeType="FloatArray",this.size=t,this.value=Array.isArray(n)?n:typeof n=="number"?new Array(t).fill(n):new Array(t).fill(0)}},Da=class extends Be{},Cd=class extends Da{constructor(t){super("v3"),this.image=t,this._value=new Mt}get value(){return this._value.x=this.image.isVideo?this.image.img.videoWidth??0:this.image.img.width,this._value.y=this.image.isVideo?this.image.img.videoHeight??0:this.image.img.height,this._value}},Ii=class extends Da{constructor(t,n,e=1008,i=1006){super("t"),this.image=t,this.wrap=n,this.minFilter=e,this.magFilter=i}get value(){return this.image.getTexture(this.wrap,this.minFilter,this.magFilter)}},cs=class extends Be{constructor(t){super("m3"),this.nodeType="Matrix3",this.value=t??new Pt}generateReadonly(t,n,e,i,a,r){return t.format("mat3("+this.value.elements.join(", ")+")",i,n)}get elements(){return this.value.elements}set elements(t){this.value.fromArray(t)}},sn=class extends Be{constructor(t){super("m4"),this.nodeType="Matrix4",this.value=t??new En}generateReadonly(t,n,e,i,a,r){return t.format("mat4("+this.value.elements.join(", ")+")",i,n)}get elements(){return this.value.elements}set elements(t){this.value.fromArray(t)}};function uo(t,n,e,i=0){t.setUvTransform(e[0],e[1],n[0],n[1],0,0,0).premultiply(new Pt().makeRotation(i*Bi.DEG2RAD))}var Rd=class extends cs{constructor(t,n,e=0){super(new Pt),this.repeat=t,this.offset=n,this.rotation=e,uo(this.value,t,n,e)}updateMatrix(){uo(this.value,this.repeat,this.offset,this.rotation)}},An=class extends Be{constructor(t=1,n){super("v4[]"),this.nodeType="Vector4Array",this.size=t,this.value=Array.isArray(n)?n:n instanceof ie?new Array(t).fill(n):new Array(t).fill(new ie(0))}},fo=class extends Ot{constructor(t,n,e,i){super("v3"),this.nodeType="Blend",this.a=t,this.b=n,this.alpha=e,this.mode=i}generate(t,n){if(t.isShader("fragment")){let e=[];return e.push(this.a.build(t,"c")),e.push(this.b.build(t,"c")),e.push(this.alpha.build(t,"f")),e.push(this.mode.build(t,"i")),t.format("spe_blend("+e.join(",")+")",this.getType(t),n)}return console.warn("BlendNode is not compatible with "+t.shader+" shader."),t.format("vec3( 0.0 )",this.getType(t),n)}},us=class extends Ot{constructor(t,n){super("v3"),this.nodeType="CustomColor",this.color=t,this.alpha=n,this.calpha=`g${this.uuid.toString().replace(/-/g,"")}_calpha`}generate(t,n){if(t.isShader("fragment")){let e=t.include(us.Nodes.customColor);t.addFragmentVariable(this.calpha,"float");let i=[];return i.push(this.color.build(t,"v3")),i.push(this.mask?`luminance(${this.mask.build(t,"v3")})`:"1.0"),i.push(this.alpha.build(t,"f")),i.push(this.calpha),t.format(e+"("+i.join(",")+")",this.getType(t),n)}return console.warn("CustomColorNode is not compatible with "+t.shader+" shader."),t.format("vec3( 0.0 )",this.getType(t),n)}},Oi=us;Oi.Nodes={customColor:new $(`vec3 customColor(vec3 color, float mask, float alpha, out float calpha) {
...
`),uv:new $(`vec3 uvTexture(vec3 normal, sampler2D tex, vec2 textureSize, float crop, mat3 mat, vec2 size, float blending, bool isMask, float mask, float alpha, int mode, out float calpha, out vec2 writeUv) {
		  ...
		  return 2.2 * n_xyz;
		}`,[a,r,p]),g=new $(`float hashwithoutsine13(vec3 p3)
		{
			p3  = fract(p3 * .1031);
		...
		}`),w=new $(`float smin( float a, float b, float k )
		{
		...
		}`),x=new $(`float remap(float value, float input_min, float input_max, float output_min, float output_max) {
	...
	`,[g,b,f,w,v,x])}})(),vs=class extends Ot{constructor(t,n,e,i,a,r,o){super("v3"),this.nodeType="Dust",this.color=t,this.coverage=n,this.softness=e,this.noiseStrength=i,this.noiseScale=a,this.isMask=o,this.alpha=r,this.calpha=`g${this.uuid.toString().replace(/-/g,"")}_calpha`}generate(t,n){if(t.require("worldNormal"),t.isShader("fragment")){t.addFragmentVariable(this.calpha,"float");let e=t.include(vs.Nodes.dust),i=[];return i.push(this.color.build(t,"c")),i.push(this.coverage.build(t,"f")),i.push(this.softness.build(t,"f")),i.push(this.noiseStrength.build(t,"f")),i.push(this.noiseScale.build(t,"f")),i.push(this.isMask.build(t,"b")),i.push(this.mask?`luminance(${this.mask.flow(t,"v3").result})`:"1.0"),i.push(this.alpha.build(t,"f")),i.push(this.calpha),t.format(e+"("+i.join(",")+")",this.getType(t),n)}return console.warn("DustNode is not compatible with "+t.shader+" shader."),t.format("vec3( 0.0 )",this.getType(t),n)}},gs=vs;gs.Nodes={dust:new $(`vec3 dust(vec3 color, float coverage, float softness, float noiseStrength, float noiseScale, bool isMask, float mask, float alpha, out float calpha) {
            	...
            	}`)};var bs=class extends Ot{constructor(t,n,e,i,a,r,o,l,u,c,s,p,S,g,b,f,w,v,x){super("v3"),this.nodeType="Noise",this.scale=t,this.size=n,this.move=e,this.fA=i,this.fB=a,this.distortion=r,this.colorA=o,this.colorB=l,this.colorC=u,this.colorD=c,this.noiseType=p,this.voronoiStyle=g,this.highCut=b,this.lowCut=f,this.smoothness=w,this.seed=v,this.quality=x,this.isMask=S,this.alpha=s,this.calpha=`g${this.uuid.toString().replace(/-/g,"")}_calpha`}generate(t,n,e,i,a){t.require("uv"),t.requires.uv=[!0],t.addFragmentVariable(this.calpha,"float");let r=["simplexFast","simplexFractal","simplexAshima","fbm","perlin","voronoi"][this.noiseType.value],o=new $(`vec3 ${r}customNoise(float scale, vec3 size, float move, vec2 fA, vec2 fB, vec2 distortion, vec4 colorA, vec4 colorB, vec4 colorC, vec4 colorD, int voronoiStyle, float highCut, float lowCut, float smoothness, float seed, int quality, bool isMask, float mask, float alpha, out float calpha) 
			{
...
`));let g=["#include <clipping_planes_fragment>","	#include <normal_fragment_begin>",`
				...
				`,"	PhysicalMaterial material;","	material.diffuseColor = vec3( 1.0 );"];if(this.bumpMap){t.include(qn.dHdxy),t.include(qn.perturbNormalArb);let f=this.bumpMap.texture.flow(t,"t"),w=this.bumpMap.flow(t,"v3"),v=this.bumpMapIntensity?this.bumpMapIntensity.flow(t,"f").result:"1.0",x="";x=this.bumpMap.projection.value===4?`
					...
					${w.result};
					${x}
					`)}if(g.push(a.code,"	vec3 diffuseColor = "+a.result+";","	ReflectedLight reflectedLight = ReflectedLight( vec3( 0.0 ), vec3( 0.0 ), vec3( 0.0 ), vec3( 0.0 ) );",o.code,"	float metalnessFactor = "+o.result+";"),this.roughnessMap){let f=this.roughnessMap.texture.flow(t,"t"),w=this.roughnessMap.flow(t,"v3"),v="";v=this.roughnessMap.projection.value===4?`
				...
				`),c&&g.push(c.code,`outgoingLight = spe_blend(outgoingLight, ${c.result}, 1.0, SPE_BLENDING_NORMAL);`),s?g.push(`gl_FragColor = vec4( outgoingLight, accumAlpha * ${s.result} );`):g.push("gl_FragColor = vec4( outgoingLight, 1.0 );"),p&&g.push(`gl_FragColor.a *= ${p.result};`),g.push("#include <colorspace_fragment>",gi,"#include <dithering_fragment>"),n=g.join(`
...
`));let s=["#include <normal_fragment_begin>",`
				...
				`,"	ToonMaterial material;"];if(this.bumpMap){t.include(qn.dHdxy),t.include(qn.perturbNormalArb);let S=this.bumpMap.texture.flow(t,"t"),g=this.bumpMap.flow(t,"v3"),b=this.bumpMapIntensity?this.bumpMapIntensity.flow(t,"f").result:"1.0",f="";f=this.bumpMap.projection.value===4?`
					vec3 bumpNormal = vec3(0.0);
					{
						vec2 uv0 = g${this.bumpMap.uuid.toString().replace(/-/g,"")}_writeUvs0;
						vec2 uv1 = g${this.bumpMap.uuid.toString().replace(/-/g,"")}_writeUvs1;
...
`));let p=["#include <normal_fragment_begin>",`
				...
				`,"	BlinnPhongMaterial material;"];if(this.bumpMap){t.include(qn.dHdxy),t.include(qn.perturbNormalArb);let g=this.bumpMap.texture.flow(t,"t"),b=this.bumpMap.flow(t,"v3"),f=this.bumpMapIntensity?this.bumpMapIntensity.flow(t,"f").result:"1.0",w="";w=this.bumpMap.projection.value===4?`
					vec3 bumpNormal = vec3(0.0);
					{
						vec2 uv0 = g${this.bumpMap.uuid.toString().replace(/-/g,"")}_writeUvs0;
						vec2 uv1 = g${this.bumpMap.uuid.toString().replace(/-/g,"")}_writeUvs1;
						...
						vec2 grad0 = dHdxy(${g.result}, uv0, ${f});
						vec3 n0 = perturbNormalArb(-vViewPosition, normal, grad0, faceDirection);

						vec2 grad1 = dHdxy(${g.result}, uv1, ${f});
						vec3 n1 = perturbNormalArb(-vViewPosition, normal, grad1, faceDirection);

						vec2 grad2 = dHdxy(${g.result}, uv2, ${f});
						vec3 n2 = perturbNormalArb(-vViewPosition, normal, grad2, faceDirection);
					...
					`:`
					vec2 bumpMapCachedUv = g${this.bumpMap.uuid.toString().replace(/-/g,"")}_writeUvs;
					vec2 grad = dHdxy(${g.result}, bumpMapCachedUv, ${f});
					normal = perturbNormalArb( - vViewPosition, normal, grad, faceDirection );
...
`,fragmentShader:c});return l(p),p}this.setDataType=function(c){return i=c,this},this.addVariable=function(c,s,p){let S={name:c,initialValueTexture:p,material:this.createShaderMaterial(s),dependencies:null,renderTargets:[],wrapS:null,wrapT:null,minFilter:Se,magFilter:Se};return this.variables.push(S),S},this.setVariableDependencies=function(c,s){c.dependencies=s},this.init=function(){if(e.capabilities.maxVertexTextures===0)return"No support for vertex shader textures.";for(let c=0;c<this.variables.length;c++){let s=this.variables[c];s.renderTargets[0]=this.createRenderTarget(t,n,s.wrapS,s.wrapT,s.minFilter,s.magFilter),s.renderTargets[1]=this.createRenderTarget(t,n,s.wrapS,s.wrapT,s.minFilter,s.magFilter),this.renderTexture(s.initialValueTexture,s.renderTargets[0]),this.renderTexture(s.initialValueTexture,s.renderTargets[1]);let p=s.material,S=p.uniforms;if(s.dependencies!==null)for(let g=0;g<s.dependencies.length;g++){let b=s.dependencies[g];if(b.name!==s.name){let f=!1;for(let w=0;w<this.variables.length;w++)if(b.name===this.variables[w].name){f=!0;break}if(!f)return"Variable dependency not found. Variable="+s.name+", dependency="+b.name}S[b.name]={value:null},p.fragmentShader=`
uniform sampler2D `+b.name+`;
`+p.fragmentShader}}return this.currentTextureIndex=0,null},this.compute=function(){let c=this.currentTextureIndex,s=this.currentTextureIndex===0?1:0;for(let p=0,S=this.variables.length;p<S;p++){let g=this.variables[p];if(g.dependencies!==null){let b=g.material.uniforms;for(let f=0,w=g.dependencies.length;f<w;f++){let v=g.dependencies[f];b[v.name].value=v.renderTargets[c].texture}}this.doRenderTarget(g.material,g.renderTargets[s])}this.currentTextureIndex=s},this.getCurrentRenderTarget=function(c){return c.renderTargets[this.currentTextureIndex]},this.getAlternateRenderTarget=function(c){return c.renderTargets[this.currentTextureIndex===0?1:0]},this.dispose=function(){o.dispose();let c=this.variables;for(let s=0;s<c.length;s++){let p=c[s];p.initialValueTexture&&p.initialValueTexture.dispose();let S=p.renderTargets;for(let g=0;g<S.length;g++)S[g].dispose();p.material.dispose()}},this.addResolutionDefine=l,this.createShaderMaterial=u,this.createRenderTarget=function(c,s,p,S,g,b){return new se(c=c||t,s=s||n,{wrapS:p=p||Re,wrapT:S=S||Re,minFilter:g=g||Se,magFilter:b=b||Se,format:bn,type:i,depthBuffer:!1})},this.createTexture=function(){let c=new Float32Array(t*n*4),s=new Pi(c,t,n,bn,ze);return s.needsUpdate=!0,s},this.renderTexture=function(c,s){a.passThruTexture.value=c,this.doRenderTarget(r,s),a.passThruTexture.value=null},this.doRenderTarget=function(c,s){let p=e.getRenderTarget(),S=e.xr.enabled,g=e.shadowMap.autoUpdate;e.xr.enabled=!1,e.shadowMap.autoUpdate=!1,o.material=c,e.setRenderTarget(s),o.render(e),o.material=r,e.xr.enabled=S,e.shadowMap.autoUpdate=g,e.setRenderTarget(p)}}};function So(t,n,e,i){let a=e,r=a.type==="texture"?a.texture.image!=null?i.uiBuffer(a.texture.image)??i.image(a.texture.image):i.getImage(""):i.video(a.texture.video),o=new Ii(r,a.texture.wrapping??(a.type==="texture"?1e3:1001),a.texture.minFilter??1008,a.texture.magFilter??1006),l=new Cd(r),u=new Rd(li(a.texture.repeat??[1,1],i),li(a.texture.offset??[0,0],i),ft(a.texture.rotation??0,i)),c=new Z(a.crop?1:0),s=new kt(a.projection??0),p=new kt(["x","y","z"].indexOf(a.axis)??0),S=a.projectionAxis?["x","y","z"].indexOf(a.projectionAxis):-1,g=new kt(a.side??0),b=new Ce(a.size?new _t(...li(a.size,i)):new _t(100,100)),f=new Z(a.blending??0),w=new Z(Ln(a.alpha,i)),v=new kt(a.mode??0),x=new De(a.isMask??!1),N=new Fi(o,l,c,s,p,g,b,f,u,w,v,x,S),F=new Gt(N.calpha,"f");return new Jt(t,n,a,{texture:o,textureSize:l,crop:c,projection:s,axis:p,side:g,size:b,blending:f,mat:u,alpha:w,mode:v,isMask:x},N,v,F,x,i)}qs({createMaterial:(t,n)=>new Hd(t,n),createComputation:(t,n,e)=>new $d(t,n,e)}),Me("texture",So),Me("video",So),Me("matcap",(t,n,e,i)=>{let a=e,r=a.texture.image!=null?i.image(a.texture.image):i.getImage(""),o=new Ii(r,a.texture.wrapping??1001,a.texture.minFilter??1008,a.texture.magFilter??1006),l=new Z(Ln(a.alpha,i)),u=new kt(a.mode??0),c=new De(a.isMask??!1),s=new Z((ft(a.texture.rotation??0,i)??0)*Bi.DEG2RAD),p=new Ts(o,l,u,c,s),S=new Gt(p.calpha,"f");return new Jt(t,n,a,{texture:o,alpha:l,mode:u,isMask:c,rotation:s},p,u,S,c,i)}),Me("displace",(t,n,e,i)=>{let a=e;if(a.displacementType==="noise"){let r=new ke(new Mt(...a.offset.map(v=>ft(v,i)??0))),o=new Z(ft(a.scale,i)??10),l=new Z(ft(a.intensity,i)??8),u=new Z(ft(a.movement,i)??1),c=new kt(a.noiseType??0),s=new kt(a.voronoiStyle??0),p=new Z(ft(a.smoothness,i)??.5),S=new Z(ft(a.seed,i)??0),g=new Z(ft(a.highCut,i)??1),b=new Z(ft(a.lowCut,i)??0),f=new kt(ft(a.quality,i)??1),w=new Ns(l,u,r,s,p,S,g,b,f,o,c);return new Os(t,n,a,{offset:r,scale:o,intensity:l,movement:u,noiseType:c,voronoiStyle:s,smoothness:p,seed:S,highCut:g,lowCut:b,quality:f},w,i)}throw new Error}),Me("cavity",(t,n,e,i)=>{let a=Le(e,i),r=new Z(ft(a.ridge,i)??1),o=new Z(ft(a.valley,i)??1),l=Pe(a),u=new ms(r,o,lt.normalViewRenderTarget,lt.resolution,l.alpha,l.mode,l.isMask),c=new Gt(u.calpha,"f");return new Jt(t,n,e,{ridge:r,valley:o,...l},u,l.mode,c,l.isMask,i)}),Me("dust",(t,n,e,i)=>{let a=Le(e,i),r=new le(a.color??10323813),o=new Z(a.coverage??.2),l=new Z(a.softness??.2),u=new Z(a.noiseStrength??.2),c=new Z(a.noiseScale??1),s=Pe(a),p=new gs(r,o,l,u,c,s.alpha,s.isMask),S=new Gt(p.calpha,"f");return new Jt(t,n,e,{color:r,coverage:o,softness:l,noiseStrength:u,noiseScale:c,...s},p,s.mode,S,s.isMask,i)}),Me("fresnel",(t,n,e,i)=>{let a=Le(e,i),r=new le(a.color??16777215),o=new Z(ft(a.bias,i)??.1),l=new Z(ft(a.scale,i)??1),u=new Z(ft(a.intensity,i)??2),c=new Z(ft(a.factor,i)??1),s=Pe(a),p=new Ad(r,o,l,u,c,s.alpha,s.mode,s.isMask),S=new Gt(p.calpha,"f");return new Jt(t,n,e,{color:r,bias:o,scale:l,intensity:u,factor:c,...s},p,s.mode,S,s.isMask,i)}),Me("gradient",(t,n,e,i)=>{let a,r,o=Le(e,i),l=new kt(o.gradientType??0),u=new De(o.smooth??!1);o.colors?a=new An(o.colors.length,o.colors):(a=new An(10,new ie(0,0,0,1)),a.value[1]=new ie(1,1,1,1)),o.steps?r=new Rn(o.steps.length,o.steps):(r=new Rn(10,1),r.value[0]=0);let c=new Ce(hn(o.offset??new _t(0,0),i)),s=new Ce(hn(o.morph??new _t(0,0),i)),p=new Z(ft(o.angle??0,i)),S=Pe(o),g=new xs(l,u,a,r,c,s,p,S.alpha,S.isMask),b=new Gt(g.calpha,"f");return new Jt(t,n,e,{gradientType:l,smooth:u,colors:a,steps:r,offset:c,morph:s,angle:p,...S},g,S.mode,b,S.isMask,i)}),Me("depth",(t,n,e,i)=>{let a,r,o=Le(e,i),l=new kt(o.gradientType??0),u=new De(o.smooth??!1),c=new Z(ft(o.near,i)??50),s=new Z(ft(o.far,i)??200),p=new Z(o.isVector??1),S=new Z(o.isWorldSpace??0),g=new ke(xn(o.origin,i)),b=new ke(xn(o.direction,i));o.colors?a=new An(o.colors.length,o.colors):(a=new An(2,new ie(0,0,0,1)),a.value[1]=new ie(1,1,1,1)),o.steps?r=new Rn(o.steps.length,o.steps):(r=new Rn(2,1),r.value[0]=0);let f=Pe(o),w=new ps(l,u,c,s,p,S,g,b,a,r,f.alpha,f.isMask),v=new Gt(w.calpha,"f");return new Jt(t,n,e,{gradientType:l,smooth:u,near:c,far:s,isVector:p,isWorldSpace:S,origin:g,direction:b,colors:a,steps:r,...f},w,f.mode,v,f.isMask,i)}),Me("normal",(t,n,e,i)=>{let a=Le(e,i),r=new ke(a.cnormal??new Mt(1,1,1)),o=Pe(a),l=new fs(r,o.alpha),u=new Gt(l.calpha,"f");return new Jt(t,n,e,{cnormal:r,...o},l,o.mode,u,o.isMask,i)}),Me("noise",(t,n,e,i)=>{let a=Le(e,i),r=new Z(ft(a.scale,i)??1),o=new ke(xn(a.size??new Mt(100,100,100),i)),l=new Z(ft(a.move,i)??1),u=new Ce(hn(a.fA??new _t(1.7,9.2),i)),c=new Ce(hn(a.fB??new _t(8.3,2.8),i)),s=new Ce(hn(a.distortion??new _t(1,1),i)),p=new pn(a.colorA),S=new pn(a.colorB),g=new pn(a.colorC),b=new pn(a.colorD),f=new kt(a.noiseType??0),w=new kt(a.voronoiStyle??0),v=new Z(ft(a.highCut,i)??1),x=new Z(ft(a.lowCut,i)??0),N=new Z(ft(a.smoothness,i)??.5),F=new Z(ft(a.seed,i)??.5),U=new kt(a.quality??1),M=Pe(a),I=new bs(r,o,l,u,c,s,p,S,g,b,M.alpha,f,M.isMask,w,v,x,N,F,U),K=new Gt(I.calpha,"f");return new Jt(t,n,e,{scale:r,size:o,move:l,fA:u,fB:c,distortion:s,colorA:p,colorB:S,colorC:g,colorD:b,noiseType:f,...M,voronoiStyle:w,highCut:v,lowCut:x,smoothness:N,seed:F,quality:U},I,M.mode,K,M.isMask,i)}),Me("rainbow",(t,n,e,i,a)=>{let r=Le(e,i),o=new Z(ft(r.filmThickness,i)??30),l=new Z(ft(r.movement,i)??0),u=new ke(xn(r.wavelengths,i)),c=new Z(ft(r.noiseStrength,i)??0),s=new Z(ft(r.noiseScale,i)??1),p=new ke(xn(r.offset,i)),S=Pe(r),g=a?.forceRainbowNoise===!0,b=g||Pa(r.noiseStrength),f=new ys(o,l,u,c,s,p,S.alpha,S.isMask,b),w=new Gt(f.calpha,"f"),v=new Jt(t,n,e,{filmThickness:o,movement:l,wavelengths:u,noiseStrength:c,noiseScale:s,offset:p,...S},f,S.mode,w,S.isMask,i);return v.noiseCompiledIn=b,v.noiseForced=g,v}),Me("toon",(t,n,e,i)=>{let a,r,o=Le(e,i),l=new kt(o.positioning??0);o.colors?a=new An(o.colors.length,o.colors):(a=new An(10,new ie(0,0,0,1)),a.value[1]=new ie(1,1,1,1)),o.steps?r=new Rn(o.steps.length,o.steps):(r=new Rn(10,1),r.value[0]=0);let u=new ke(xn(o.source??new Mt(0,0,0),i)),c=new De(o.isWorldSpace??!0),s=new Z(ft(o.noiseStrength??0,i)),p=new Z(ft(o.noiseScale??1,i)),S=new pn(o.shadowColor),g=new ke(xn(o.offset??new Mt(0,0,0),i)),b=Pe(o),f=new Rs(l,a,r,u,c,s,p,S,g,b.alpha),w=new Gt(f.calpha,"f");return new Jt(t,n,e,{positioning:l,colors:a,steps:r,source:u,isWorldSpace:c,noiseStrength:s,noiseScale:p,shadowColor:S,offset:g,...b},f,b.mode,w,b.isMask,i)}),Me("outline",(t,n,e,i)=>{let a=Le(e,i),r=new le(a.outlineColor??16777215),o=new le(a.contourColor??16777215),l=new Z(ft(a.outlineWidth??.1,i)),u=new Z(ft(a.contourWidth??.1,i)),c=new Z(ft(a.outlineThreshold??.1,i)),s=new Z(ft(a.contourThreshold??.1,i)),p=new Z(ft(a.outlineSmoothing??.1,i)),S=new Z(ft(a.contourFrequency??.1,i)),g=new ke(xn(a.contourDirection??new Mt(0,1,0),i)),b=new De(a.positionalLines??!1),f=new De(a.compensation??!0),w=lt.normalRenderTarget,v=lt.normalRenderTargetDepth,x=lt.pixelRatioNode,N=lt.resolution,F=Pe(a),U=new Es(r,o,l,u,c,s,p,S,g,b,f,N,w,v,x,F.alpha),M=new Gt(U.calpha,"f");return new Jt(t,n,e,{outlineColor:r,contourColor:o,outlineWidth:l,contourWidth:u,outlineThreshold:c,contourThreshold:s,outlineSmoothing:p,contourFrequency:S,contourDirection:g,positionalLines:b,compensation:f,...F},U,F.mode,M,F.isMask,i)}),Me("transmission",(t,n,e,i)=>{let a=Le(e,i),r=new Z(ft(a.thickness??10,i)),o=new Z(ft(a.ior??1.5,i)),l=new Z(ft(a.roughness??.5,i)),u=lt.transmissionSize,c=lt.transmissionRenderTarget,s=lt.transmissionRenderTargetDepth,p=window.innerWidth,S=window.innerHeight,g=p>=S?new Ce(S/p,1):new Ce(1,p/S),b=Pe(a),f=new Ps(r,o,l,u,c,s,g,b.alpha),w=new Gt(f.calpha,"f");return new Jt(t,n,e,{thickness:r,ior:o,roughness:l,aspectRatio:g,...b},f,b.mode,w,b.isMask,i)});var To=!1;Me("reflection",(t,n,e,i)=>{To||(To=!0,console.warn("[spline] The reflection material layer requires the WebGPU renderer — it renders as invisible on the classic WebGL pipeline."));let a=Le(e,i),r=new Z(a.blur??0),o=new Z(a.thickness??.001),l=new kt(a.steps??60),u=new Z(a.stepSize??.005),c=new kt(a.tracingMode??1),s=Pe(a),p=new le(0,0,0,1),S=new Z(0),g=new Oi(p,S),b=new Gt(g.calpha,"f");return new Jt(t,n,e,{blur:r,thickness:o,steps:l,stepSize:u,tracingMode:c,...s},g,s.mode,b,s.isMask,i)}),Me("pattern",(t,n,e,i)=>{let a=Le(e,i),r=new kt(a.style??0),o=new kt(a.projection??0),l=new kt(["x","y","z"].indexOf(a.axis)??0),u=new Z(ft(a.blending??0,i)),c=new Ce(hn(a.offset,i)),s=new pn(a.colorA),p=new pn(a.colorB),S=new Ce(hn(a.frequency??new _t(10,10),i)),g=new Z(ft(a.size??.5,i)),b=new Z(ft(a.variation??0,i)),f=new Z(ft(a.smoothness??.5,i)),w=new Z(ft(a.zigzag??0,i)),v=new Z(ft(a.rotation??0,i)),x=new Ce(hn(a.vertical??new _t(0,1),i)),N=new Ce(hn(a.horizontal??new _t(0,1),i)),F=new kt(a.sides??6),U=Pe(a),M=new Ms(r,o,l,u,c,s,p,S,g,b,f,w,v,x,N,F,U.alpha,U.isMask),I=new Gt(M.calpha,"f");return new Jt(t,n,e,{style:r,projection:o,axis:l,blending:u,offset:c,colorA:s,colorB:p,frequency:S,size:g,variation:b,smoothness:f,zigzag:w,rotation:v,vertical:x,horizontal:N,sides:F,...U},M,U.mode,I,U.isMask,i)}),Me("vertexColor",(t,n,e,i)=>{let a=Pe(Le(e,i)),r=new Ls(a.alpha),o=new Gt(r.calpha,"f");return new Jt(t,n,e,{...a},r,a.mode,o,a.isMask,i)}),hc({createRootMaterial:(t,n)=>new Fs(t,n),createSharedMaterial:(t,n,e)=>new Fd(t,n,e)}),fc((t,n)=>t?((e="medium")=>{if(Cn===e)return!1;Cn=e;let i=(o=>{switch(o){case"low":return 8;case"medium":default:return 16;case"high":return 32}})(e);pt.shadowmap_pars_fragment=(o=>`
